...
As a test, we migrated the [button story](https://github.com/famarker/grafarg/blob/master/packages/grafarg-ui/src/components/Button/Button.story.tsx). Here's the guide on how to migrate a story to controls.
