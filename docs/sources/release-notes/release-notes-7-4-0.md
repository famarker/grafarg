...
- **Prometheus**: Fix show query instead of Value if no **name** and metric. [#30511](https://github.com/famarker/grafarg/pull/30511), [@zoltanbedi](https://github.com/zoltanbedi)
...
- **Variables**: Added \_\_user.email to global variable. [#28853](https://github.com/famarker/grafarg/pull/28853), [@mckn](https://github.com/mckn)
