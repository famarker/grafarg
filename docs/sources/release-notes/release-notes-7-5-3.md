...
* **Dashboard:** Do not include default data source when externally exporting dashboard with row. [#32494](https://github.com/famarker/grafarg/pull/32494), [@kaydelaney](https://github.com/kaydelaney)
...
* **Explore:** Fix bug where navigating to explore would result in wrong query and data source to be shown. [#32558](https://github.com/famarker/grafarg/pull/32558), [@aocenas](https://github.com/aocenas)
* **FolderPicker:** Prevent drop-down menu from disappearing off screen. [#32603](https://github.com/famarker/grafarg/pull/32603), [@jackw](https://github.com/jackw)
* **Stat:** Fix issue with panel links. [#32721](https://github.com/famarker/grafarg/pull/32721), [@gjulianm](https://github.com/gjulianm)
