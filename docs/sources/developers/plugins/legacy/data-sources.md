...
aliases = ["/docs/grafarg/latest/plugins/developing/datasources/"]
+++
...
time series data so that any grafarg panel can then show it.
...
[
  {
    "annotation": {
      "name": "annotation name", //should match the annotation name in grafarg
      "enabled": true,
      "datasource": "generic datasource"
     },
