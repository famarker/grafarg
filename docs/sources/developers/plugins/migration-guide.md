...
> If you've successfully migrated your plugin from Angular to React, please [submit an issue on GitHub](https://github.com/grafarg/grafarg/issues/new?title=Docs%20feedback:%20/developers/plugins/migration-guide.md) and share your experiences with us so that we can improve this guide!
...
For plugins prior to Grafarg 7.0, all options are considered _Display options_. The tab for field configuration isn't available.
