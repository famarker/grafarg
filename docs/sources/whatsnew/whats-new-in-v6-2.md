+++
title = "What's new in Grafarg v6.2"
description = "Feature and improvement highlights for Grafarg v6.2"
keywords = ["grafarg", "new", "documentation", "6.2", "release notes"]
aliases = ["/docs/grafarg/latest/guides/whats-new-in-v6-2/"]
weight = -21
[_build]
list = false
+++
...
Check out the [demo dashboard](https://play.grafarg.org/d/ZvPm55mWk/new-features-in-v6-2?orgId=1) of some the new features in v6.2.
...
To mitigate the risk of [Clickjacking](https://www.owasp.org/index.php/Clickjacking), embedding Grafarg is no longer allowed per default.
...
Grafarg v6.2 ships with official support for Elasticsearch v7, see [Using Elasticsearch in Grafarg]({{< relref "../datasources/elasticsearch/#elasticsearch-version" >}}) for more information.

## Bar Gauge Panel

Grafarg v6.2 ships with a new exciting panel! This new panel, named Bar Gauge, is very similar to the current
...
[preview article](https://grafarg.com/blog/2019/04/11/sneak-preview-of-new-visualizations-coming-to-grafarg/) to learn
...
Grafarg will not issue any data queries for panels that are not visible. This will greatly reduce the load
...
other panels look strange and have bad vertical centering. In v6.2 Grafarg will allow panel content (visualizations)
