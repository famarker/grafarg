...
// In a Grafarg alerting scenario it needs to operate on decoded frames, which is why this function is
// preferrable. When encoded data frames are needed, e.g. returned from Grafarg HTTP API, it will
...
// plugin or similar. This may allow the encoded data frames to be returned to Grafarg UI without any additional
// decoding/encoding required. In Grafarg alerting scenario it needs to operate on decoded data frames why encoded
