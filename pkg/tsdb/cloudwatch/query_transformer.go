...
// buildDeepLink generates a deep link from Grafarg to the CloudWatch console. The link params are based on metric(s) for a given query row in the Query Editor.
