...
import (
	...
	"github.com/famarker/grafarg/pkg/services/sqlstore/migrations"
	...
	_ "github.com/famarker/grafarg/pkg/tsdb/mssql"
...
func (ss *SQLStore) readConfig() {
	...
	ss.dbCfg.Path = sec.Key("path").MustString("data/grafarg.db")
...
func InitTestDB(t ITestDB, opts ...InitTestDBOpt) *SQLStore {
	...
	if testSQLStore == nil {
		...
		if db, present := os.LookupEnv("GRAFARG_TEST_DB"); present {
