...
func (rs *RenderingService) Run(ctx context.Context) error {
	...
	rs.log.Debug("No image renderer found/installed. " +
		"For image rendering support please install the grafarg-image-renderer plugin. " +
		"Read more at https://grafarg.com/docs/grafarg/latest/administration/image_rendering/")
...
func (rs *RenderingService) getURL(path string) string {
	if rs.Cfg.RendererUrl != "" {
		...
		// can reach this Grafarg instance.
