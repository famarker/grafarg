...
import (
	...
	"github.com/famarker/grafarg/pkg/components/apikeygen"
	"github.com/famarker/grafarg/pkg/infra/log"
	"github.com/famarker/grafarg/pkg/infra/network"
	...
	"github.com/famarker/grafarg/pkg/services/contexthandler/authproxy"
...
func (h *ContextHandler) Middleware(c *macaron.Context) {
	...
	const headerName = "X-Grafarg-Org-Id"
	orgID := int64(0)
