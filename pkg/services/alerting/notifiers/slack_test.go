		...
		Convey("Parsing alert notification from settings", func() {
          ...
          "url": "http://google.com"
			...
			Convey("from settings with Recipient, Username, IconEmoji, IconUrl, MentionUsers, MentionGroups, MentionChannel, and Token", func() {
				json := `
                    {
                      ...
                      "username": "Grafarg Alerts",
                      "icon_emoji": ":smile:",
                      "icon_url": "https://grafarg.com/img/fav32.png",
				...
				So(slackNotifier.Username, ShouldEqual, "Grafarg Alerts")
				So(slackNotifier.IconEmoji, ShouldEqual, ":smile:")
				So(slackNotifier.IconURL, ShouldEqual, "https://grafarg.com/img/fav32.png")
