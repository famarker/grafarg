...
func TestSensuGoNotifier(t *testing.T) {
	...
	json = `
	{
		...
		"entity": "grafarg_instance_01",
		"check": "grafarg_rule_0",
		"namespace": "default",
		"handler": "myhandler",
	...
	assert.Equal(t, "grafarg_instance_01", sensuGoNotifier.Entity)
	assert.Equal(t, "grafarg_rule_0", sensuGoNotifier.Check)
