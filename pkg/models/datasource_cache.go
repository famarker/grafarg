...
var datasourceRequestSummary = prometheus.NewSummaryVec(
	prometheus.SummaryOpts{
		...
		Help:       "summary of outgoing datasource requests sent from Grafarg",
...
var datasourceResponseSummary = prometheus.NewSummaryVec(
	prometheus.SummaryOpts{
		...
		Help:       "summary of datasource response sizes returned to Grafarg",
		Objectives: map[float64]float64{0.5: 0.05, 0.9: 0.01, 0.99: 0.001},
	}, []string{"datasource"},
)
...
var datasourceRequestsInFlight = prometheus.NewGaugeVec(
	prometheus.GaugeOpts{
		...
		Help:      "A gauge of outgoing datasource requests currently being sent by Grafarg",
	},
	[]string{"datasource"},
)
