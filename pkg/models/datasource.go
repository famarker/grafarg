...
var knownDatasourcePlugins = map[string]bool{
	...
	"zabbix":                                 true,
	"newrelic-app":                           true,
	"grafarg-datadog-datasource":             true,
	"grafarg-simple-json":                    true,
	"grafarg-splunk-datasource":              true,
	"udoprog-heroic-datasource":              true,
	"grafarg-openfalcon-datasource":          true,
	...
	"grafarg-influxdb-flux-datasource":       true,
	"doitintl-bigquery-datasource":           true,
	"grafarg-azure-data-explorer-datasource": true,
	"tempo":                                  true,
}
