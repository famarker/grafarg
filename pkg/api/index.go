...
func (hs *HTTPServer) getNavTree(c *models.ReqContext, hasEditPerm bool) ([]*dtos.NavLink, error) {
	...
	if hasEditPerm {
		...
		children = append(children, &dtos.NavLink{
			Text: "Import", SubTitle: "Import dashboard from file or Grafarg.com", Id: "import", Icon: "import",
...
func (hs *HTTPServer) setIndexViewData(c *models.ReqContext) (*dtos.IndexViewData, error) {
	...
	data := dtos.IndexViewData{
		User: &dtos.CurrentUser{
			...
			OrgRole:                    c.OrgRole,
			GravatarUrl:                dtos.GetGravatarUrl(c.Email),
			IsGrafargAdmin:             c.IsGrafargAdmin,
		...
		NewGrafargVersion:       hs.PluginManager.GrafargLatestVersion,
		NewGrafargVersionExists: hs.PluginManager.GrafargHasUpdate,
