...
func (hs *HTTPServer) getFrontendSettingsMap(c *models.ReqContext) (map[string]interface{}, error) {
	...
	jsonObj := map[string]interface{}{
		...
		"allowOrgCreate":             (setting.AllowUserOrgCreate && c.IsSignedIn) || c.IsGrafargAdmin,
		...
		"buildInfo": map[string]interface{}{
			...
			"latestVersion": hs.PluginManager.GrafargLatestVersion,
			"hasUpdate":     hs.PluginManager.GrafargHasUpdate,
			"env":           setting.Env,
