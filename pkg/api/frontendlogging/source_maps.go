 ...
 * and only considers sources coming from grafarg core or plugins`
 */
func (store *SourceMapStore) guessSourceMapLocation(sourceURL string) (*sourceMapLocation, error) {
	...
	// determine if source comes from grafarg core, locally or CDN, look in public build dir on fs
