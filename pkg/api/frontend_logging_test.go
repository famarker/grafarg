...
func logSentryEventScenario(t *testing.T, desc string, event frontendlogging.FrontendSentryEvent, fn logScenarioFunc) {
	t.Run(desc, func(t *testing.T) {
		...
		cdnRootURL, e := url.Parse("https://storage.googleapis.com/grafarg-static-assets")
		require.NoError(t, e)
				...
				Values: []frontendlogging.FrontendSentryExceptionValue{
					{
						...
						Stacktrace: sentry.Stacktrace{
							Frames: []sentry.Frame{
								...
								{
									Function: "cdn",
									Filename: "https://storage.googleapis.com/grafarg-static-assets/grafarg-oss/pre-releases/7.5.0-11925pre/public/build/foo.js", // source map found and mapped
									Lineno:   3,
									Colno:    10,
								},
							},
