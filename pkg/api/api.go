...
import (
	...
	"github.com/famarker/grafarg/pkg/api/avatar"
...
func (hs *HTTPServer) registerRoutes() {
	...
	reqGrafargAdmin := middleware.ReqGrafargAdmin
	...
	r.Get("/org/new", reqGrafargAdmin, hs.Index)
	...
	r.Get("/configuration", reqGrafargAdmin, hs.Index)
	r.Get("/admin", reqGrafargAdmin, hs.Index)
	r.Get("/admin/settings", reqGrafargAdmin, hs.Index)
	r.Get("/admin/users", reqGrafargAdmin, hs.Index)
	r.Get("/admin/users/create", reqGrafargAdmin, hs.Index)
	r.Get("/admin/users/edit/:id", reqGrafargAdmin, hs.Index)
	r.Get("/admin/orgs", reqGrafargAdmin, hs.Index)
	r.Get("/admin/orgs/edit/:id", reqGrafargAdmin, hs.Index)
	r.Get("/admin/stats", reqGrafargAdmin, hs.Index)
	r.Get("/admin/ldap", reqGrafargAdmin, hs.Index)
	...
	r.Group("/api", func(apiRoute routing.RouteRegister) {
		...
		// search all orgs
		apiRoute.Get("/orgs", reqGrafargAdmin, routing.Wrap(SearchOrgs))
		...
		apiRoute.Get("/tsdb/testdata/gensql", reqGrafargAdmin, routing.Wrap(GenerateSQLTestData))
