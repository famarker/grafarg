...
import (
	...
	"github.com/famarker/grafarg/pkg/services/live"
	...
	httpstatic "github.com/famarker/grafarg/pkg/api/static"
	...
	"github.com/famarker/grafarg/pkg/services/librarypanels"
	"github.com/famarker/grafarg/pkg/services/login"
	"github.com/famarker/grafarg/pkg/services/provisioning"
...
func (hs *HTTPServer) addMiddlewaresAndStaticRoutes() {
	...
	// These endpoints are used for monitoring the Grafarg instance
...
// healthzHandler always return 200 - Ok if Grafarg's web server is running
...
// apiHealthHandler will return ok if Grafarg's web server is running and it
