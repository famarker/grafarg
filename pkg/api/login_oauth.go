...
func (hs *HTTPServer) OAuthLogin(ctx *models.ReqContext) {
	...
	// validate that the email is allowed to login to grafarg
...
// syncUser syncs a Grafarg user profile with the corresponding OAuth profile.
func syncUser(
	ctx *models.ReqContext,
	extUser *models.ExternalUserInfo,
	connect social.SocialConnector,
) (*models.User, error) {
	oauthLogger.Debug("Syncing Grafarg user with corresponding OAuth profile")
	// add/update user in Grafarg
