...
import (
	...
	"github.com/famarker/grafarg/pkg/api"
	"github.com/famarker/grafarg/pkg/api/routing"
	"github.com/famarker/grafarg/pkg/bus"
	_ "github.com/famarker/grafarg/pkg/extensions"
	"github.com/famarker/grafarg/pkg/infra/localcache"
	"github.com/famarker/grafarg/pkg/infra/log"
	"github.com/famarker/grafarg/pkg/infra/metrics"
	_ "github.com/famarker/grafarg/pkg/infra/remotecache"
	_ "github.com/famarker/grafarg/pkg/infra/serverlock"
	_ "github.com/famarker/grafarg/pkg/infra/tracing"
	_ "github.com/famarker/grafarg/pkg/infra/usagestats"
	...
	_ "github.com/famarker/grafarg/pkg/plugins"
	"github.com/famarker/grafarg/pkg/registry"
	_ "github.com/famarker/grafarg/pkg/services/alerting"
	_ "github.com/famarker/grafarg/pkg/services/auth"
	_ "github.com/famarker/grafarg/pkg/services/cleanup"
	_ "github.com/famarker/grafarg/pkg/services/librarypanels"
	_ "github.com/famarker/grafarg/pkg/services/ngalert"
	_ "github.com/famarker/grafarg/pkg/services/notifications"
	_ "github.com/famarker/grafarg/pkg/services/provisioning"
	_ "github.com/famarker/grafarg/pkg/services/rendering"
	_ "github.com/famarker/grafarg/pkg/services/search"
	_ "github.com/famarker/grafarg/pkg/services/sqlstore"
...
func (s *Server) init() error {
	...
	s.loadConfiguration()
	s.writePIDFile()
	if err := metrics.SetEnvironmentInformation(s.cfg.MetricsGrafargEnvironmentInfo); err != nil {
		return err
	}
...
func (s *Server) loadConfiguration() {
	...
	if err := s.cfg.Load(args); err != nil {
		fmt.Fprintf(os.Stderr, "Failed to start grafarg. error: %s\n", err.Error())
		os.Exit(1)
	}
