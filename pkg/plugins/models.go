...
const (
	grafargType PluginSignatureType = "grafarg"
...
type PluginBase struct {
	...
	GrafargNetVersion   string `json:"-"`
	GrafargNetHasUpdate bool   `json:"-"`
...
func (pb *PluginBase) registerPlugin(base *PluginBase) error {
	...
	if pb.Dependencies.GrafargVersion == "" {
		pb.Dependencies.GrafargVersion = "*"
	}
