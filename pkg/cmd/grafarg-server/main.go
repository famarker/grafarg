...
import (
	...
	"github.com/famarker/grafarg/pkg/extensions"
	"github.com/famarker/grafarg/pkg/infra/log"
	"github.com/famarker/grafarg/pkg/infra/metrics"
	"github.com/famarker/grafarg/pkg/server"
	_ "github.com/famarker/grafarg/pkg/services/alerting/conditions"
	_ "github.com/famarker/grafarg/pkg/services/alerting/notifiers"
	"github.com/famarker/grafarg/pkg/setting"
	_ "github.com/famarker/grafarg/pkg/tsdb/azuremonitor"
	_ "github.com/famarker/grafarg/pkg/tsdb/cloudmonitoring"
	_ "github.com/famarker/grafarg/pkg/tsdb/cloudwatch"
	_ "github.com/famarker/grafarg/pkg/tsdb/elasticsearch"
	_ "github.com/famarker/grafarg/pkg/tsdb/graphite"
	_ "github.com/famarker/grafarg/pkg/tsdb/influxdb"
	_ "github.com/famarker/grafarg/pkg/tsdb/loki"
	_ "github.com/famarker/grafarg/pkg/tsdb/mysql"
	_ "github.com/famarker/grafarg/pkg/tsdb/opentsdb"
	_ "github.com/famarker/grafarg/pkg/tsdb/postgres"
	_ "github.com/famarker/grafarg/pkg/tsdb/prometheus"
	_ "github.com/famarker/grafarg/pkg/tsdb/tempo"
	_ "github.com/famarker/grafarg/pkg/tsdb/testdatasource"
)
...
func main() {
	var (
		...
		homePath   = flag.String("homepath", "", "path to grafarg install/home path, defaults to working directory")
		pidFile    = flag.String("pidfile", "", "path to pid file")
		packaging  = flag.String("packaging", "unknown", "describes the way Grafarg was installed")
