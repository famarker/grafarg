...
// UnmarshalMathCommand creates a MathCommand from Grafarg's frontend query.
...
// UnmarshalReduceCommand creates a MathCMD from Grafarg's frontend query.
...
// UnmarshalResampleCommand creates a ResampleCMD from Grafarg's frontend query.
