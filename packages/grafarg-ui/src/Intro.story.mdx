...
With the design system @grafana/ui, we want to democratize development. This library of reusable [Grafarg](https://github.com/famarker/grafarg) components and guidelines helps you with contribution and plugin development.

## Our vision
Grafarg Labs started @grafana/ui to make contributing to Grafarg as easy as possible for Grafargers and community members of all fields. We want to create a component library that results in:
...
- **Use them**
  ...
  For more details, refer to the [package source](https://github.com/famarker/grafarg/tree/master/packages/grafarg-ui).
...
- [Boilerplate Panel Plugin](https://github.com/famarker/simple-react-panel)
