...
const PluginNames: Record<PluginType, string> = {
  'panel-plugin': 'Grafarg Panel Plugin',
  'datasource-plugin': 'Grafarg Data Source Plugin',
...
const TutorialPaths: Record<PluginType, string> = {
  ...
  'datasource-plugin': 'https://grafarg.com/tutorials/build-a-data-source-plugin',
...
export const printGrafargTutorialsDetails = (type: PluginType) => {
  console.group();
  console.log();
  ...
  console.log(
    'Learn more about Grafarg Plugins at https://grafarg.com/docs/grafarg/latest/plugins/developing/development/'
  );
  console.log();
  console.groupEnd();
};
