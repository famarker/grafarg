...
import { DataSourceApi, FieldType, getFieldDisplayName, isDataFrame, MetricFindValue, PanelData } from '@grafarg/data';
  ...
  return (source) =>
    source.pipe(
      mergeMap(() => {
        ...
        // The if statement below fixes https://github.com/famarker/grafarg/issues/25671
        if (!searchFilter) {
