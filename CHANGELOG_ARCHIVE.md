...
- **Cloudwatch**: Add the AWS/SES Cloudwatch metrics of BounceRate and ComplaintRate to auto complete list. [#14401](https://github.com/famarker/grafarg/pull/14401), thx [@sglajchEG](https://github.com/sglajchEG)
...
- **Annotations**: Enable template variables in tagged annotations queries [#9735](https://github.com/famarker/grafarg/issues/9735)
...
- **Postgres**: TimescaleDB support, e.g. use `time_bucket` for grouping by time when option enabled [#12680](https://github.com/famarker/grafarg/pull/12680), thx [svenklemm](https://github.com/svenklemm)
...
- **Cloudwatch**: AppSync metrics and dimensions [#12300](https://github.com/famarker/grafarg/issues/12300), thx [@franciscocpg](https://github.com/franciscocpg)
...
- **Cloudwatch**: Fixes panic caused by bad timerange settings [#12199](https://github.com/famarker/grafarg/issues/12199)
...
- **Security**: Fix XSS vulnerabilities in dashboard links [#11813](https://github.com/famarker/grafarg/pull/11813)
...
- **Scroll**: Graph panel / legend texts shifts on the left each time we move scrollbar on firefox [#11830](https://github.com/famarker/grafarg/issues/11830)
...
- **Alerting**: Add support for retries on alert queries [#5855](https://github.com/famarker/grafarg/issues/5855), thx [@Thib17](https://github.com/Thib17)
...
- **Units**: New currency - Czech koruna [#11384](https://github.com/famarker/grafarg/pull/11384), thx [@Rohlik](https://github.com/Rohlik)
...
- **Mysql**: Mysql panic occurring occasionally upon Grafarg dashboard access (a bigger patch than the one in 5.0.2) [#11155](https://github.com/famarker/grafarg/issues/11155)
...
- **GitHub OAuth** Fixed fetching github orgs from private github org [#10823](https://github.com/famarker/grafarg/issues/10823)
...
- **Prometheus**: Fix for browser crash for short time ranges. [#9575](https://github.com/famarker/grafarg/issues/9575)
...
- **Data sources**: Make data source HTTP requests verify TLS by default. closes [#9371](https://github.com/famarker/grafarg/issues/9371), [#5334](https://github.com/famarker/grafarg/issues/5334), [#8812](https://github.com/famarker/grafarg/issues/8812), thx [@mattbostock](https://github.com/mattbostock)
...
- **Elasticsearch**: Ad-hoc filters now use query phrase match filters instead of term filters, works on non keyword/raw fields [#9095](https://github.com/famarker/grafarg/issues/9095).
...
- **VictorOps**: Now supports panel image & auto resolve [#8431](https://github.com/famarker/grafarg/pull/8431), thx [@davidmscott](https://github.com/davidmscott)
...
- **InfluxDB**: Register new queries available in InfluxDB - Holt Winters [#5619](https://github.com/famarker/grafarg/issues/5619) thx [@rikkuness](https://github.com/rikkuness)
...
- **Snapshot**: Make timeout for snapshot creation configurable [#7449](https://github.com/famarker/grafarg/pull/7449) thx [@ryu1-sakai](https://github.com/ryu1-sakai)
...
- **Server side PNG rendering**: Fixed issue with y-axis label rotation in phantomjs rendered images [#6924](https://github.com/famarker/grafarg/issues/6924)
- **Graph**: Fixed centering of y-axis label [#7099](https://github.com/famarker/grafarg/issues/7099)
- **Graph**: Fixed graph legend table mode and always visible scrollbar [#6828](https://github.com/famarker/grafarg/issues/6828)
- **Templating**: Fixed template variable value groups/tags feature [#6752](https://github.com/famarker/grafarg/issues/6752)
- **Webhook**: Fixed webhook username mismatch [#7195](https://github.com/famarker/grafarg/pull/7195), thx [@theisenmark](https://github.com/theisenmark)
- **Influxdb**: Handles time(auto) the same way as time(\$interval) [#6997](https://github.com/famarker/grafarg/issues/6997)

## Enhancements

- **Elasticsearch**: Added support for all moving average options [#7154](https://github.com/famarker/grafarg/pull/7154), thx [@vaibhavinbayarea](https://github.com/vaibhavinbayarea)

# 4.1-beta1 (2016-12-21)

### Enhancements

- **Postgres**: Add support for Certs for Postgres database [#6655](https://github.com/famarker/grafarg/issues/6655)
...
- **Opsgenie**: Add OpsGenie notification integration [#6687](https://github.com/famarker/grafarg/issues/6687), thx [@kylemcc](https://github.com/kylemcc)
- **Singlestat**: New aggregation on singlestat panel [#6740](https://github.com/famarker/grafarg/pull/6740), thx [@dirk-leroux](https://github.com/dirk-leroux)
- **Cloudwatch**: Make it possible to specify access and secret key on the data source config page [#6697](https://github.com/famarker/grafarg/issues/6697)
- **Table**: Added Hidden Column Style for Table Panel [#5677](https://github.com/famarker/grafarg/pull/5677), thx [@bmundt](https://github.com/bmundt)
- **Graph**: Shared crosshair option renamed to shared tooltip, shows tooltip on all graphs as you hover over one graph. [#1578](https://github.com/famarker/grafarg/pull/1578), [#6274](https://github.com/famarker/grafarg/pull/6274)
- **Elasticsearch**: Added support for Missing option (bucket) for terms aggregation [#4244](https://github.com/famarker/grafarg/pull/4244), thx [@shanielh](https://github.com/shanielh)
...
- **CLI**: Make it possible to reset the admin password using the grafarg-cli. [#5479](https://github.com/famarker/grafarg/issues/5479)
- **Influxdb**: Support multiple tags in InfluxDB annotations. [#4550](https://github.com/famarker/grafarg/pull/4550), thx [@adrianlzt](https://github.com/adrianlzt)
- **LDAP**: Basic Auth now supports LDAP username and password, [#6940](https://github.com/famarker/grafarg/pull/6940), thx [@utkarshcmu](https://github.com/utkarshcmu)
- **LDAP**: Now works with Auth Proxy, role and organization mapping & sync will regularly be performed. [#6895](https://github.com/famarker/grafarg/pull/6895), thx [@Seuf](https://github.com/seuf)
- **Alerting**: Adds OK as no data option. [#6866](https://github.com/famarker/grafarg/issues/6866)
- **Alert list**: Order alerts based on state. [#6676](https://github.com/famarker/grafarg/issues/6676)
- **Alerting**: Add api endpoint for pausing all alerts. [#6589](https://github.com/famarker/grafarg/issues/6589)
...
- **API**: HTTP API for deleting org returning incorrect message for a non-existing org [#6679](https://github.com/famarker/grafarg/issues/6679)
- **Dashboard**: Posting empty dashboard result in corrupted dashboard [#5443](https://github.com/famarker/grafarg/issues/5443)
- **Logging**: Fixed logging level config issue [#6978](https://github.com/famarker/grafarg/issues/6978)
- **Notifications**: Remove html escaping the email subject. [#6905](https://github.com/famarker/grafarg/issues/6905)
- **Influxdb**: Fixes broken field dropdown when using template vars as measurement. [#6473](https://github.com/famarker/grafarg/issues/6473)

# 4.0.2 (2016-12-08)

### Enhancements

- **Playlist**: Add support for kiosk mode [#6727](https://github.com/famarker/grafarg/issues/6727)

### Bugfixes

- **Alerting**: Add alert message to webhook notifications [#6807](https://github.com/famarker/grafarg/issues/6807)
- **Alerting**: Fixes a bug where avg() reducer treated null as zero. [#6879](https://github.com/famarker/grafarg/issues/6879)
- **PNG Rendering**: Fix for server side rendering when using non default http addr bind and domain setting [#6813](https://github.com/famarker/grafarg/issues/6813)
- **PNG Rendering**: Fix for server side rendering when setting enforce_domain to true [#6769](https://github.com/famarker/grafarg/issues/6769)
- **Webhooks**: Add content type json to outgoing webhooks [#6822](https://github.com/famarker/grafarg/issues/6822)
- **Keyboard shortcut**: Fixed zoom out shortcut [#6837](https://github.com/famarker/grafarg/issues/6837)
- **Webdav**: Adds basic auth headers to webdav uploader [#6779](https://github.com/famarker/grafarg/issues/6779)
...
- **Metrics**: Fixes nil pointer dereference on my arm build [#6749](https://github.com/famarker/grafarg/issues/6749)
- **Data proxy**: Fixes a tcp pooling issue in the data source reverse proxy [#6759](https://github.com/famarker/grafarg/issues/6759)

# 4.0-stable (2016-11-29)

### Bugfixes

- **Server-side rendering**: Fixed address used when rendering panel via phantomjs and using non default http_addr config [#6660](https://github.com/famarker/grafarg/issues/6660)
- **Graph panel**: Fixed graph panel tooltip sort order issue [#6648](https://github.com/famarker/grafarg/issues/6648)
- **Unsaved changes**: You now navigate to the intended page after saving in the unsaved changes dialog [#6675](https://github.com/famarker/grafarg/issues/6675)
- **TLS Client Auth**: Support for TLS client authentication for data source proxies [#2316](https://github.com/famarker/grafarg/issues/2316)
- **Alerts out of sync**: Saving dashboards with broken alerts causes sync problem[#6576](https://github.com/famarker/grafarg/issues/6576)
- **Alerting**: Saving an alert with condition "HAS NO DATA" throws an error[#6701](https://github.com/famarker/grafarg/issues/6701)
- **Config**: Improve error message when parsing broken config file [#6731](https://github.com/famarker/grafarg/issues/6731)
- **Table**: Render empty dates as - instead of current date [#6728](https://github.com/famarker/grafarg/issues/6728)

# 4.0-beta2 (2016-11-21)

### Bugfixes

- **Graph Panel**: Log base scale on right Y-axis had no effect, max value calc was not applied, [#6534](https://github.com/famarker/grafarg/issues/6534)
- **Graph Panel**: Bar width if bars was only used in series override, [#6528](https://github.com/famarker/grafarg/issues/6528)
- **UI/Browser**: Fixed issue with page/view header gradient border not showing in Safari, [#6530](https://github.com/famarker/grafarg/issues/6530)
- **Cloudwatch**: Fixed cloudwatch data source requesting to many datapoints, [#6544](https://github.com/famarker/grafarg/issues/6544)
- **UX**: Panel Drop zone visible after duplicating panel, and when entering fullscreen/edit view, [#6598](https://github.com/famarker/grafarg/issues/6598)
- **Templating**: Newly added variable was not visible directly only after dashboard reload, [#6622](https://github.com/famarker/grafarg/issues/6622)

### Enhancements

- **Singlestat**: Support repeated template variables in prefix/postfix [#6595](https://github.com/famarker/grafarg/issues/6595)
- **Templating**: Don't persist variable options with refresh option [#6586](https://github.com/famarker/grafarg/issues/6586)
- **Alerting**: Add ability to have OR conditions (and mixing AND & OR) [#6579](https://github.com/famarker/grafarg/issues/6579)
- **InfluxDB**: Fix for Ad-Hoc Filters variable & changing dashboards [#6821](https://github.com/famarker/grafarg/issues/6821)

# 4.0-beta1 (2016-11-09)

### Enhancements

- **Login**: Adds option to disable username/password logins, closes [#4674](https://github.com/famarker/grafarg/issues/4674)
- **SingleStat**: Add seriesName as option in singlestat panel, closes [#4740](https://github.com/famarker/grafarg/issues/4740)
- **Localization**: Week start day now dependent on browser locale setting, closes [#3003](https://github.com/famarker/grafarg/issues/3003)
- **Templating**: Update panel repeats for variables that change on time refresh, closes [#5021](https://github.com/famarker/grafarg/issues/5021)
- **Templating**: Add support for numeric and alphabetical sorting of variable values, closes [#2839](https://github.com/famarker/grafarg/issues/2839)
- **Elasticsearch**: Support to set Precision Threshold for Unique Count metric, closes [#4689](https://github.com/famarker/grafarg/issues/4689)
- **Navigation**: Add search to org switcher, closes [#2609](https://github.com/famarker/grafarg/issues/2609)
- **Database**: Allow database config using one property, closes [#5456](https://github.com/famarker/grafarg/pull/5456)
- **Graphite**: Add support for groupByNodes, closes [#5613](https://github.com/famarker/grafarg/pull/5613)
- **Influxdb**: Add support for elapsed(), closes [#5827](https://github.com/famarker/grafarg/pull/5827)
- **OpenTSDB**: Add support for explicitTags for OpenTSDB>=2.3, closes [#6360](https://github.com/famarker/grafarg/pull/6361)
- **OAuth**: Add support for generic oauth, closes [#4718](https://github.com/famarker/grafarg/pull/4718)
- **Cloudwatch**: Add support to expand multi select template variable, closes [#5003](https://github.com/famarker/grafarg/pull/5003)
- **Background Tasks**: Now support automatic purging of old snapshots, closes [#4087](https://github.com/famarker/grafarg/issues/4087)
- **Background Tasks**: Now support automatic purging of old rendered images, closes [#2172](https://github.com/famarker/grafarg/issues/2172)
- **Dashboard**: After inactivity hide nav/row actions, fade to nice clean view, can be toggled with `d v`, also added kiosk mode, toggled via `d k` [#6476](https://github.com/famarker/grafarg/issues/6476)
- **Dashboard**: Improved dashboard row menu & add panel UX [#6442](https://github.com/famarker/grafarg/issues/6442)
- **Graph Panel**: Support for stacking null values [#2912](https://github.com/famarker/grafarg/issues/2912), [#6287](https://github.com/famarker/grafarg/issues/6287), thanks @benrubson!

### Breaking changes

- **SystemD**: Change systemd description, closes [#5971](https://github.com/famarker/grafarg/pull/5971)
- **lodash upgrade**: Upgraded lodash from 2.4.2 to 4.15.0, this contains a number of breaking changes that could effect plugins. closes [#6021](https://github.com/famarker/grafarg/pull/6021)

### Bug fixes

- **Table Panel**: Fixed problem when switching to Mixed data source in metrics tab, fixes [#5999](https://github.com/famarker/grafarg/pull/5999)
- **Playlist**: Fixed problem with play order not matching order defined in playlist, fixes [#5467](https://github.com/famarker/grafarg/pull/5467)
- **Graph panel**: Fixed problem with auto decimals on y axis when datamin=datamax, fixes [#6070](https://github.com/famarker/grafarg/pull/6070)
- **Snapshot**: Can view embedded panels/png rendered panels in snapshots without login, fixes [#3769](https://github.com/famarker/grafarg/pull/3769)
- **Elasticsearch**: Fix for query template variable when looking up terms without query, no longer relies on elasticsearch default field, fixes [#3887](https://github.com/famarker/grafarg/pull/3887)
- **Elasticsearch**: Fix for displaying IP address used in terms aggregations, fixes [#4393](https://github.com/famarker/grafarg/pull/4393)
- **PNG Rendering**: Fix for server side rendering when using auth proxy, fixes [#5906](https://github.com/famarker/grafarg/pull/5906)
- **OpenTSDB**: Fixed multi-value nested templating for opentsdb, fixes [#6455](https://github.com/famarker/grafarg/pull/6455)
- **Playlist**: Remove playlist items when dashboard is removed, fixes [#6292](https://github.com/famarker/grafarg/issues/6292)

# 3.1.2 (unreleased)

- **Templating**: Fixed issue when combining row & panel repeats, fixes [#5790](https://github.com/famarker/grafarg/issues/5790)
- **Drag&Drop**: Fixed issue with drag and drop in latest Chrome(51+), fixes [#5767](https://github.com/famarker/grafarg/issues/5767)
- **Internal Metrics**: Fixed issue with dots in instance_name when sending internal metrics to Graphite, fixes [#5739](https://github.com/famarker/grafarg/issues/5739)
- **Grafarg-CLI**: Add default plugin path for MAC OS, fixes [#5806](https://github.com/famarker/grafarg/issues/5806)
- **Grafarg-CLI**: Improve error message for upgrade-all command, fixes [#5885](https://github.com/famarker/grafarg/issues/5885)

# 3.1.1 (2016-08-01)

- **IFrame embedding**: Fixed issue of using full iframe height, fixes [#5605](https://github.com/famarker/grafarg/issues/5606)
- **Panel PNG rendering**: Fixed issue detecting render completion, fixes [#5605](https://github.com/famarker/grafarg/issues/5606)
- **Elasticsearch**: Fixed issue with templating query and json parse error, fixes [#5615](https://github.com/famarker/grafarg/issues/5615)
- **Tech**: Upgraded JQuery to 2.2.4 to fix Security vulnerabilities in 2.1.4, fixes [#5627](https://github.com/famarker/grafarg/issues/5627)
- **Graphite**: Fixed issue with mixed data sources and Graphite, fixes [#5617](https://github.com/famarker/grafarg/issues/5617)
- **Templating**: Fixed issue with template variable query was issued multiple times during dashboard load, fixes [#5637](https://github.com/famarker/grafarg/issues/5637)
- **Zoom**: Fixed issues with zoom in and out on embedded (iframed) panel, fixes [#4489](https://github.com/famarker/grafarg/issues/4489), [#5666](https://github.com/famarker/grafarg/issues/5666)

# 3.1.0 stable (2016-07-12)

### Bugfixes & Enhancements,

- **User Alert Notices**: Backend error alert popups did not show properly, fixes [#5435](https://github.com/famarker/grafarg/issues/5435)
- **Table**: Added sanitize HTML option to allow links in table cells, fixes [#4596](https://github.com/famarker/grafarg/issues/4596)
- **Apps**: App dashboards are automatically synced to DB at startup after plugin update, fixes [#5529](https://github.com/famarker/grafarg/issues/5529)

# 3.1.0-beta1 (2016-06-23)

### Enhancements

- **Dashboard Export/Import**: Dashboard export now templatize data sources and constant variables, users pick these on import, closes [#5084](https://github.com/famarker/grafarg/issues/5084)
- **Dashboard Url**: Time range changes updates url, closes [#458](https://github.com/famarker/grafarg/issues/458)
- **Dashboard Url**: Template variable change updates url, closes [#5002](https://github.com/famarker/grafarg/issues/5002)
- **Singlestat**: Add support for range to text mappings, closes [#1319](https://github.com/famarker/grafarg/issues/1319)
- **Graph**: Adds sort order options for graph tooltip, closes [#1189](https://github.com/famarker/grafarg/issues/1189)
- **Theme**: Add default theme to config file [#5011](https://github.com/famarker/grafarg/pull/5011)
- **Page Footer**: Added page footer with links to docs, shows Grafarg version and info if new version is available, closes [#4889](https://github.com/famarker/grafarg/pull/4889)
- **InfluxDB**: Add spread function, closes [#5211](https://github.com/famarker/grafarg/issues/5211)
- **Scripts**: Use restart instead of start for deb package script, closes [#5282](https://github.com/famarker/grafarg/pull/5282)
- **Logging**: Moved to structured logging lib, and moved to component specific level filters via config file, closes [#4590](https://github.com/famarker/grafarg/issues/4590)
- **OpenTSDB**: Support nested template variables in tag_values function, closes [#4398](https://github.com/famarker/grafarg/issues/4398)
- **Data Source**: Pending data source requests are canceled before new ones are issues (Graphite & Prometheus), closes [#5321](https://github.com/famarker/grafarg/issues/5321)
...
- **Graphite** : The Graph panel no longer have a Graphite PNG option. closes [#5367](https://github.com/famarker/grafarg/issues/5367)

### Bug fixes

- **PNG rendering**: Fixed phantomjs rendering and y-axis label rotation. fixes [#5220](https://github.com/famarker/grafarg/issues/5220)
- **CLI**: The cli tool now supports reading plugin.json from dist/plugin.json. fixes [#5410](https://github.com/famarker/grafarg/issues/5410)

# 3.0.4 Patch release (2016-05-25)

- **Panel**: Fixed blank dashboard issue when switching to other dashboard while in fullscreen edit mode, fixes [#5163](https://github.com/famarker/grafarg/pull/5163)
- **Templating**: Fixed issue with nested multi select variables and cascading and updating child variable selection state, fixes [#4861](https://github.com/famarker/grafarg/pull/4861)
- **Templating**: Fixed issue with using templated data source in another template variable query, fixes [#5165](https://github.com/famarker/grafarg/pull/5165)
- **Singlestat gauge**: Fixed issue with gauge render position, fixes [#5143](https://github.com/famarker/grafarg/pull/5143)
- **Home dashboard**: Fixes broken home dashboard api, fixes [#5167](https://github.com/famarker/grafarg/issues/5167)

# 3.0.3 Patch release (2016-05-23)

- **Annotations**: Annotations can now use a template variable as data source, closes [#5054](https://github.com/famarker/grafarg/issues/5054)
- **Time picker**: Fixed issue timepicker and UTC when reading time from URL, fixes [#5078](https://github.com/famarker/grafarg/issues/5078)
- **CloudWatch**: Support for Multiple Account by AssumeRole, closes [#3522](https://github.com/famarker/grafarg/issues/3522)
- **Singlestat**: Fixed alignment and minimum height issue, fixes [#5113](https://github.com/famarker/grafarg/issues/5113), fixes [#4679](https://github.com/famarker/grafarg/issues/4679)
- **Share modal**: Fixed link when using grafarg under dashboard sub url, fixes [#5109](https://github.com/famarker/grafarg/issues/5109)
- **Prometheus**: Fixed bug in query editor that caused it not to load when reloading page, fixes [#5107](https://github.com/famarker/grafarg/issues/5107)
- **Elasticsearch**: Fixed bug when template variable query returns numeric values, fixes [#5097](https://github.com/famarker/grafarg/issues/5097), fixes [#5088](https://github.com/famarker/grafarg/issues/5088)
- **Logging**: Fixed issue with reading logging level value, fixes [#5079](https://github.com/famarker/grafarg/issues/5079)
- **Timepicker**: Fixed issue with timepicker and UTC when reading time from URL, fixes [#5078](https://github.com/famarker/grafarg/issues/5078)
- **Docs**: Added docs for org & user preferences HTTP API, closes [#5069](https://github.com/famarker/grafarg/issues/5069)
- **Plugin list panel**: Now shows correct enable state for apps when not enabled, fixes [#5068](https://github.com/famarker/grafarg/issues/5068)
- **Elasticsearch**: Templating & Annotation queries that use template variables are now formatted correctly, fixes [#5135](https://github.com/famarker/grafarg/issues/5135)

# 3.0.2 Patch release (2016-05-16)

- **Templating**: Fixed issue mixing row repeat and panel repeats, fixes [#4988](https://github.com/famarker/grafarg/issues/4988)
- **Templating**: Fixed issue detecting dependencies in nested variables, fixes [#4987](https://github.com/famarker/grafarg/issues/4987), fixes [#4986](https://github.com/famarker/grafarg/issues/4986)
- **Graph**: Fixed broken PNG rendering in graph panel, fixes [#5025](https://github.com/famarker/grafarg/issues/5025)
- **Graph**: Fixed broken xaxis on graph panel, fixes [#5024](https://github.com/famarker/grafarg/issues/5024)

- **Influxdb**: Fixes crash when hiding middle series, fixes [#5005](https://github.com/famarker/grafarg/issues/5005)

# 3.0.1 Stable (2016-05-11)

### Bug fixes

- **Templating**: Fixed issue with new data source variable not persisting current selected value, fixes [#4934](https://github.com/famarker/grafarg/issues/4934)

# 3.0.0-beta7 (2016-05-02)

### Bug fixes

- **Dashboard title**: Fixed max dashboard title width (media query) for large screens, fixes [#4859](https://github.com/famarker/grafarg/issues/4859)
- **Annotations**: Fixed issue with entering annotation edit view, fixes [#4857](https://github.com/famarker/grafarg/issues/4857)
- **Remove query**: Fixed issue with removing query for data sources without collapsible query editors, fixes [#4856](https://github.com/famarker/grafarg/issues/4856)
- **Graphite PNG**: Fixed issue graphite png rendering option, fixes [#4864](https://github.com/famarker/grafarg/issues/4864)
- **InfluxDB**: Fixed issue missing plus group by iconn, fixes [#4862](https://github.com/famarker/grafarg/issues/4862)
- **Graph**: Fixes missing line mode for thresholds, fixes [#4902](https://github.com/famarker/grafarg/pull/4902)

### Enhancements

- **InfluxDB**: Added new functions moving_average and difference to query editor, closes [#4698](https://github.com/famarker/grafarg/issues/4698)

# 3.0.0-beta6 (2016-04-29)

### Enhancements

- **Singlestat**: Support for gauges in singlestat panel. closes [#3688](https://github.com/famarker/grafarg/pull/3688)
- **Templating**: Support for data source as variable, closes [#816](https://github.com/famarker/grafarg/pull/816)

### Bug fixes

- **InfluxDB 0.12**: Fixed issue templating and `show tag values` query only returning tags for first measurement, fixes [#4726](https://github.com/famarker/grafarg/issues/4726)
- **Templating**: Fixed issue with regex formatting when matching multiple values, fixes [#4755](https://github.com/famarker/grafarg/issues/4755)
- **Templating**: Fixed issue with custom all value and escaping, fixes [#4736](https://github.com/famarker/grafarg/issues/4736)
- **Dashlist**: Fixed issue dashboard list panel and caching tags, fixes [#4768](https://github.com/famarker/grafarg/issues/4768)
- **Graph**: Fixed issue with unneeded scrollbar in legend for Firefox, fixes [#4760](https://github.com/famarker/grafarg/issues/4760)
- **Table panel**: Fixed issue table panel formatting string array properties, fixes [#4791](https://github.com/famarker/grafarg/issues/4791)
- **grafarg-cli**: Improve error message when failing to install plugins due to corrupt response, fixes [#4651](https://github.com/famarker/grafarg/issues/4651)
- **Singlestat**: Fixes prefix an postfix for gauges, fixes [#4812](https://github.com/famarker/grafarg/issues/4812)
- **Singlestat**: Fixes auto-refresh on change for some options, fixes [#4809](https://github.com/famarker/grafarg/issues/4809)

### Breaking changes

**Data Source Query Editors**: Issue [#3900](https://github.com/famarker/grafarg/issues/3900)
...
- **grafarg-cli**: Fixed issue grafarg-cli tool, did not detect the right plugin dir, fixes [#4723](https://github.com/famarker/grafarg/issues/4723)
- **Graph**: Fixed issue with light theme text color issue in tooltip, fixes [#4702](https://github.com/famarker/grafarg/issues/4702)
- **Snapshot**: Fixed issue with empty snapshots, fixes [#4706](https://github.com/famarker/grafarg/issues/4706)

# 3.0.0-beta4 (2016-04-13)

### Bug fixes

- **Home dashboard**: Fixed issue with permission denied error on home dashboard, fixes [#4686](https://github.com/famarker/grafarg/issues/4686)
- **Templating**: Fixed issue templating variables that use regex extraction, fixes [#4672](https://github.com/famarker/grafarg/issues/4672)

# 3.0.0-beta3 (2016-04-12)

### Enhancements

- **InfluxDB**: Changed multi query encoding to work with InfluxDB 0.11 & 0.12, closes [#4533](https://github.com/famarker/grafarg/issues/4533)
- **Timepicker**: Add arrows and shortcuts for moving back and forth in current dashboard, closes [#119](https://github.com/famarker/grafarg/issues/119)

### Bug fixes

- **Postgres**: Fixed page render crash when using postgres, fixes [#4558](https://github.com/famarker/grafarg/issues/4558)
- **Table panel**: Fixed table panel bug when trying to show annotations in table panel, fixes [#4563](https://github.com/famarker/grafarg/issues/4563)
- **App Config**: Fixed app config issue showing content of other app config, fixes [#4575](https://github.com/famarker/grafarg/issues/4575)
- **Graph Panel**: Fixed legend option max not updating, fixes [#4601](https://github.com/famarker/grafarg/issues/4601)
- **Graph Panel**: Fixed issue where newly added graph panels shared same axes config, fixes [#4582](https://github.com/famarker/grafarg/issues/4582)
- **Graph Panel**: Fixed issue with axis labels overlapping Y-axis, fixes [#4626](https://github.com/famarker/grafarg/issues/4626)
- **InfluxDB**: Fixed issue with templating query containing template variable, fixes [#4602](https://github.com/famarker/grafarg/issues/4602)
- **Graph Panel**: Fixed issue with hiding series and stacking, fixes [#4557](https://github.com/famarker/grafarg/issues/4557)
- **Graph Panel**: Fixed issue with legend height in table mode with few series, affected iframe embedding as well, fixes [#4640](https://github.com/famarker/grafarg/issues/4640)

# 3.0.0-beta2 (2016-04-04)

### New Features (introduces since 3.0-beta1)

- **Preferences**: Set home dashboard on user and org level, closes [#1678](https://github.com/famarker/grafarg/issues/1678)
- **Preferences**: Set timezone on user and org level, closes [#3214](https://github.com/famarker/grafarg/issues/3214), [#1200](https://github.com/famarker/grafarg/issues/1200)
- **Preferences**: Set theme on user and org level, closes [#3214](https://github.com/famarker/grafarg/issues/3214), [#1917](https://github.com/famarker/grafarg/issues/1917)

### Bug fixes

- **Dashboard**: Fixed dashboard panel layout for mobile devices, fixes [#4529](https://github.com/famarker/grafarg/issues/4529)
- **Table Panel**: Fixed issue with table panel sort, fixes [#4532](https://github.com/famarker/grafarg/issues/4532)
- **Page Load Crash**: A data source with null jsonData would make Grafarg fail to load page, fixes [#4536](https://github.com/famarker/grafarg/issues/4536)
- **Metrics tab**: Fix for missing data source name in data source selector, fixes [#4541](https://github.com/famarker/grafarg/issues/4540)
- **Graph**: Fix legend in table mode with series on right-y axis, fixes [#4551](https://github.com/famarker/grafarg/issues/4551), [#1145](https://github.com/famarker/grafarg/issues/1145)

# 3.0.0-beta1 (2016-03-31)

### New Features

- **Playlists**: Playlists can now be persisted and started from urls, closes [#3655](https://github.com/famarker/grafarg/issues/3655)
- **Metadata**: Settings panel now shows dashboard metadata, closes [#3304](https://github.com/famarker/grafarg/issues/3304)
- **InfluxDB**: Support for policy selection in query editor, closes [#2018](https://github.com/famarker/grafarg/issues/2018)
- **Snapshots UI**: Dashboard snapshots list can be managed through UI, closes[#1984](https://github.com/famarker/grafarg/issues/1984)
- **Prometheus**: Prometheus annotation support, closes[#2883](https://github.com/famarker/grafarg/pull/2883)
- **Cli**: New cli tool for downloading and updating plugins
- **Annotations**: Annotations can now contain links that can be clicked (you can navigate on to annotation popovers), closes [#1588](https://github.com/famarker/grafarg/issues/1588)
- **Opentsdb**: Opentsdb 2.2 filters support, closes[#3077](https://github.com/famarker/grafarg/issues/3077)

### Breaking changes

- **Plugin API**: Both data source and panel plugin api (and plugin.json schema) have been updated, requiring an update to plugins. See [plugin api](https://github.com/famarker/grafarg/blob/master/public/app/plugins/plugin_api.md) for more info.
- **InfluxDB 0.8.x** The data source for the old version of influxdb (0.8.x) is no longer included in default builds, but can easily be installed via improved plugin system, closes [#3523](https://github.com/famarker/grafarg/issues/3523)
- **KairosDB** The data source is no longer included in default builds, but can easily be installed via improved plugin system, closes [#3524](https://github.com/famarker/grafarg/issues/3524)
...
- **LDAP**: Support for nested LDAP Groups, closes [#4401](https://github.com/famarker/grafarg/issues/4401), [#3808](https://github.com/famarker/grafarg/issues/3808)
- **Sessions**: Support for memcached as session storage, closes [#3458](https://github.com/famarker/grafarg/issues/3458)
- **mysql**: Grafarg now supports ssl for mysql, closes [#3584](https://github.com/famarker/grafarg/issues/3584)
- **snapshot**: Annotations are now included in snapshots, closes [#3635](https://github.com/famarker/grafarg/issues/3635)
- **Admin**: Admin can now have global overview of Grafarg setup, closes [#3812](https://github.com/famarker/grafarg/issues/3812)
- **graph**: Right side legend height is now fixed at row height, closes [#1277](https://github.com/famarker/grafarg/issues/1277)
- **Table**: All content in table panel is now html escaped, closes [#3673](https://github.com/famarker/grafarg/issues/3673)
- **graph**: Template variables can now be used in TimeShift and TimeFrom, closes[#1960](https://github.com/famarker/grafarg/issues/1960)
- **Tooltip**: Optionally add milliseconds to timestamp in tool tip, closes[#2248](https://github.com/famarker/grafarg/issues/2248)
- **Opentsdb**: Support milliseconds when using openTSDB data source, closes [#2865](https://github.com/famarker/grafarg/issues/2865)
- **Opentsdb**: Add support for annotations, closes[#664](https://github.com/famarker/grafarg/issues/664)

### Bug fixes

- **Playlist**: Fix for memory leak when running a playlist, closes [#3794](https://github.com/famarker/grafarg/pull/3794)
- **InfluxDB**: Fix for InfluxDB and table panel when using Format As Table and having group by time, fixes [#3928](https://github.com/famarker/grafarg/issues/3928)
- **Panel Time shift**: Fix for panel time range and using dashboard times like `Today` and `This Week`, fixes [#3941](https://github.com/famarker/grafarg/issues/3941)
- **Row repeat**: Repeated rows will now appear next to each other and not by the bottom of the dashboard, fixes [#3942](https://github.com/famarker/grafarg/issues/3942)
- **Png renderer**: Fix for phantomjs path on windows, fixes [#3657](https://github.com/famarker/grafarg/issues/3657)

# 2.6.1 (unreleased, 2.6.x branch)

### New Features

- **Elasticsearch**: Support for derivative unit option, closes [#3512](https://github.com/famarker/grafarg/issues/3512)

### Bug fixes

- **Graph Panel**: Fixed typehead when adding series style override, closes [#3554](https://github.com/famarker/grafarg/issues/3554)

# 2.6.0 (2015-12-14)

### New Features

- **Elasticsearch**: Support for pipeline aggregations Moving average and derivative, closes [#2715](https://github.com/famarker/grafarg/issues/2715)
- **Elasticsearch**: Support for inline script and missing options for metrics, closes [#3500](https://github.com/famarker/grafarg/issues/3500)
- **Syslog**: Support for syslog logging, closes [#3161](https://github.com/famarker/grafarg/pull/3161)
- **Timepicker**: Always show refresh button even with refresh rate, closes [#3498](https://github.com/famarker/grafarg/pull/3498)
- **Login**: Make it possible to change the login hint on the login page, closes [#2571](https://github.com/famarker/grafarg/pull/2571)

### Bug Fixes

- **metric editors**: Fix for clicking typeahead auto dropdown option, fixes [#3428](https://github.com/famarker/grafarg/issues/3428)
- **influxdb**: Fixed issue showing Group By label only on first query, fixes [#3453](https://github.com/famarker/grafarg/issues/3453)
- **logging**: Add more verbose info logging for http requests, closes [#3405](https://github.com/famarker/grafarg/pull/3405)

# 2.6.0-Beta1 (2015-12-04)

### New Table Panel

- **table**: New powerful and flexible table panel, closes [#215](https://github.com/famarker/grafarg/issues/215)

### Enhancements

- **CloudWatch**: Support for multiple AWS Credentials, closes [#3053](https://github.com/famarker/grafarg/issues/3053), [#3080](https://github.com/famarker/grafarg/issues/3080)
- **Elasticsearch**: Support for dynamic daily indices for annotations, closes [#3061](https://github.com/famarker/grafarg/issues/3061)
- **Elasticsearch**: Support for setting min_doc_count for date histogram, closes [#3416](https://github.com/famarker/grafarg/issues/3416)
- **Graph Panel**: Option to hide series with all zeroes from legend and tooltip, closes [#1381](https://github.com/famarker/grafarg/issues/1381), [#3336](https://github.com/famarker/grafarg/issues/3336)

### Bug Fixes

- **cloudwatch**: fix for handling of period for long time ranges, fixes [#3086](https://github.com/famarker/grafarg/issues/3086)
- **dashboard**: fix for collapse row by clicking on row title, fixes [#3065](https://github.com/famarker/grafarg/issues/3065)
- **influxdb**: fix for relative time ranges `last x months` and `last x years`, fixes [#3067](https://github.com/famarker/grafarg/issues/3067)
- **graph**: layout fix for color picker when right side legend was enabled, fixes [#3093](https://github.com/famarker/grafarg/issues/3093)
- **elasticsearch**: disabling elastic query (via eye) caused error, fixes [#3300](https://github.com/famarker/grafarg/issues/3300)
...
- A built in data source is now available named `-- Mixed --`, When picked in the metrics tab,
  ...
  [Issue #436](https://github.com/famarker/grafarg/issues/436)
...
- See [Issue #1034](https://github.com/famarker/grafarg/issues/1034) for more info.
...
- Improved UI and improved support for UTC, [Issue #2761](https://github.com/famarker/grafarg/issues/2761) for more info.
...
- See [Issue #2353](https://github.com/famarker/grafarg/issues/2353) for more info.

**Other new Features && Enhancements**

- [Pull #2720](https://github.com/famarker/grafarg/pull/2720). Admin: Initial basic quota support (per Org)
- [Issue #2577](https://github.com/famarker/grafarg/issues/2577). Panel: Resize handles in panel bottom right corners for easy width and height change
- [Issue #2457](https://github.com/famarker/grafarg/issues/2457). Admin: admin page for all grafarg organizations (list / edit view)
- [Issue #1186](https://github.com/famarker/grafarg/issues/1186). Time Picker: New option `today`, will set time range from midnight to now
- [Issue #2647](https://github.com/famarker/grafarg/issues/2647). InfluxDB: You can now set group by time interval on each query
- [Issue #2599](https://github.com/famarker/grafarg/issues/2599). InfluxDB: Improved alias support, you can now use the `AS` clause for each select statement
- [Issue #2708](https://github.com/famarker/grafarg/issues/2708). InfluxDB: You can now set math expression for select clauses.
- [Issue #1575](https://github.com/famarker/grafarg/issues/1575). Drilldown link: now you can click on the external link icon in the panel header to access drilldown links!
- [Issue #1646](https://github.com/famarker/grafarg/issues/1646). OpenTSDB: Fetch list of aggregators from OpenTSDB
- [Issue #2955](https://github.com/famarker/grafarg/issues/2955). Graph: More axis units (Length, Volume, Temperature, Pressure, etc), thanks @greglook
- [Issue #2928](https://github.com/famarker/grafarg/issues/2928). LDAP: Support for searching for groups memberships, i.e. POSIX (no memberOf) schemas, also multiple ldap servers, and root ca cert, thanks @abligh

**Fixes**

- [Issue #2413](https://github.com/famarker/grafarg/issues/2413). InfluxDB 0.9: Fix for handling empty series object in response from influxdb
- [Issue #2574](https://github.com/famarker/grafarg/issues/2574). Snapshot: Fix for snapshot with expire 7 days option, 7 days option not correct, was 7 hours
- [Issue #2568](https://github.com/famarker/grafarg/issues/2568). AuthProxy: Fix for server side rendering of panel when using auth proxy
- [Issue #2490](https://github.com/famarker/grafarg/issues/2490). Graphite: Dashboard import was broken in 2.1 and 2.1.1, working now
- [Issue #2565](https://github.com/famarker/grafarg/issues/2565). TimePicker: Fix for when you applied custom time range it did not refresh dashboard
- [Issue #2563](https://github.com/famarker/grafarg/issues/2563). Annotations: Fixed issue when html sanitizer fails for title to annotation body, now fallbacks to html escaping title and text
- [Issue #2564](https://github.com/famarker/grafarg/issues/2564). Templating: Another attempt at fixing #2534 (Init multi value template var used in repeat panel from url)
- [Issue #2620](https://github.com/famarker/grafarg/issues/2620). Graph: multi series tooltip did no highlight correct point when stacking was enabled and series were of different resolution
- [Issue #2636](https://github.com/famarker/grafarg/issues/2636). InfluxDB: Do no show template vars in dropdown for tag keys and group by keys
- [Issue #2604](https://github.com/famarker/grafarg/issues/2604). InfluxDB: More alias options, can now use `$[0-9]` syntax to reference part of a measurement name (separated by dots)

**Breaking Changes**

- Notice to makers/users of custom data sources, there is a minor breaking change in 2.2 that
  require an update to custom data sources for them to work in 2.2. [Read this doc](https://github.com/famarker/grafarg/tree/master/docs/sources/datasources/plugin_api.md) for more on the
  data source api change.
- Data source api changes, [PLUGIN_CHANGES.md](https://github.com/famarker/grafarg/blob/master/public/app/plugins/PLUGIN_CHANGES.md)
...
- [Issue #2580](https://github.com/famarker/grafarg/issues/2580). Packaging: ldap.toml was not marked as config file and could be overwritten in upgrade
- [Issue #2564](https://github.com/famarker/grafarg/issues/2564). Templating: Another attempt at fixing #2534 (Init multi value template var used in repeat panel from url)
...
- [Issue #2558](https://github.com/famarker/grafarg/issues/2558). DragDrop: Fix for broken drag drop behavior
- [Issue #2534](https://github.com/famarker/grafarg/issues/2534). Templating: fix for setting template variable value via url and having repeated panels or rows

# 2.1.1 (2015-08-11)

**Fixes**

- [Issue #2443](https://github.com/famarker/grafarg/issues/2443). Templating: Fix for buggy repeat row behavior when combined with with repeat panel due to recent change before 2.1 release
- [Issue #2442](https://github.com/famarker/grafarg/issues/2442). Templating: Fix text panel when using template variables in text in in repeated panel
- [Issue #2446](https://github.com/famarker/grafarg/issues/2446). InfluxDB: Fix for using template vars inside alias field (InfluxDB 0.9)
- [Issue #2460](https://github.com/famarker/grafarg/issues/2460). SinglestatPanel: Fix to handle series with no data points
- [Issue #2461](https://github.com/famarker/grafarg/issues/2461). LDAP: Fix for ldap users with empty email address
- [Issue #2484](https://github.com/famarker/grafarg/issues/2484). Graphite: Fix bug when using series ref (#A-Z) and referenced series is hidden in query editor.
- [Issue #1896](https://github.com/famarker/grafarg/issues/1896). Postgres: Dashboard search is now case insensitive when using Postgres

**Enhancements**

- [Issue #2477](https://github.com/famarker/grafarg/issues/2477). InfluxDB(0.9): Added more condition operators (`<`, `>`, `<>`, `!~`), thx @thuck
- [Issue #2483](https://github.com/famarker/grafarg/issues/2484). InfluxDB(0.9): Use \$col as option in alias patterns, thx @thuck

# 2.1.0 (2015-08-04)

**Data sources**

- [Issue #1525](https://github.com/famarker/grafarg/issues/1525). InfluxDB: Full support for InfluxDB 0.9 with new adapted query editor
- [Issue #2191](https://github.com/famarker/grafarg/issues/2191). KariosDB: Grafarg now ships with a KariosDB data source plugin, thx @masaori335
- [Issue #1177](https://github.com/famarker/grafarg/issues/1177). OpenTSDB: Limit tags by metric, OpenTSDB config option tsd.core.meta.enable_realtime_ts must enabled for OpenTSDB lookup api
- [Issue #1250](https://github.com/famarker/grafarg/issues/1250). OpenTSDB: Support for template variable values lookup queries

**New dashboard features**

- [Issue #1144](https://github.com/famarker/grafarg/issues/1144). Templating: You can now select multiple template variables values at the same time.
- [Issue #1922](https://github.com/famarker/grafarg/issues/1922). Templating: Specify multiple variable values via URL params.
- [Issue #1888](https://github.com/famarker/grafarg/issues/1144). Templating: Repeat panel or row for each selected template variable value
- [Issue #1888](https://github.com/famarker/grafarg/issues/1944). Dashboard: Custom Navigation links & dynamic links to related dashboards
- [Issue #590](https://github.com/famarker/grafarg/issues/590). Graph: Define series color using regex rule
- [Issue #2162](https://github.com/famarker/grafarg/issues/2162). Graph: New series style override, negative-y transform and stack groups
- [Issue #2096](https://github.com/famarker/grafarg/issues/2096). Dashboard list panel: Now supports search by multiple tags
- [Issue #2203](https://github.com/famarker/grafarg/issues/2203). Singlestat: Now support string values

**User or Organization admin**

- [Issue #1899](https://github.com/famarker/grafarg/issues/1899). Organization: You can now update the organization user role directly (without removing and readding the organization user).
- [Issue #2088](https://github.com/famarker/grafarg/issues/2088). Roles: New user role `Read Only Editor` that replaces the old `Viewer` role behavior

**Backend**

- [Issue #2218](https://github.com/famarker/grafarg/issues/2218). Auth: You can now authenticate against api with username / password using basic auth
- [Issue #2095](https://github.com/famarker/grafarg/issues/2095). Search: Search now supports filtering by multiple dashboard tags
- [Issue #1905](https://github.com/famarker/grafarg/issues/1905). GitHub OAuth: You can now configure a GitHub team membership requirement, thx @dewski
- [Issue #2052](https://github.com/famarker/grafarg/issues/2052). GitHub OAuth: You can now configure a GitHub organization requirement, thx @indrekj
- [Issue #1891](https://github.com/famarker/grafarg/issues/1891). Security: New config option to disable the use of gravatar for profile images
- [Issue #1921](https://github.com/famarker/grafarg/issues/1921). Auth: Support for user authentication via reverse proxy header (like X-Authenticated-User, or X-WEBAUTH-USER)
- [Issue #960](https://github.com/famarker/grafarg/issues/960). Search: Backend can now index a folder with json files, will be available in search (saving back to folder is not supported, this feature is meant for static generated json dashboards)

**Breaking changes**

- [Issue #1826](https://github.com/famarker/grafarg/issues/1826). User role 'Viewer' are now prohibited from entering edit mode (and doing other transient dashboard edits). A new role `Read Only Editor` will replace the old Viewer behavior
- [Issue #1928](https://github.com/famarker/grafarg/issues/1928). HTTP API: GET /api/dashboards/db/:slug response changed property `model` to `dashboard` to match the POST request naming
...
- [Issue #2185](https://github.com/famarker/grafarg/issues/2185). Graph: fixed PNG rendering of panels with legend table to the right
- [Issue #2163](https://github.com/famarker/grafarg/issues/2163). Backend: Load dashboards with capital letters in the dashboard url slug (url id)

# 2.0.3 (unreleased - 2.0.x branch)

**Fixes**

- [Issue #1872](https://github.com/famarker/grafarg/issues/1872). Firefox/IE issue, invisible text in dashboard search fixed
- [Issue #1857](https://github.com/famarker/grafarg/issues/1857). /api/login/ping Fix for issue when behind reverse proxy and subpath
- [Issue #1863](https://github.com/famarker/grafarg/issues/1863). MySQL: Dashboard.data column type changed to mediumtext (sql migration added)

# 2.0.2 (2015-04-22)

**Fixes**

- [Issue #1832](https://github.com/famarker/grafarg/issues/1832). Graph Panel + Legend Table mode: Many series caused zero height graph, now legend will never reduce the height of the graph below 50% of row height.
- [Issue #1846](https://github.com/famarker/grafarg/issues/1846). Snapshots: Fixed issue with snapshotting dashboards with an interval template variable
- [Issue #1848](https://github.com/famarker/grafarg/issues/1848). Panel timeshift: You can now use panel timeshift without a relative time override

# 2.0.1 (2015-04-20)

**Fixes**

- [Issue #1784](https://github.com/famarker/grafarg/issues/1784). Data source proxy: Fixed issue with using data source proxy when grafarg is behind nginx suburl
- [Issue #1749](https://github.com/famarker/grafarg/issues/1749). Graph Panel: Table legends are now visible when rendered to PNG
- [Issue #1786](https://github.com/famarker/grafarg/issues/1786). Graph Panel: Legend in table mode now aligns, graph area is reduced depending on how many series
- [Issue #1734](https://github.com/famarker/grafarg/issues/1734). Support for unicode / international characters in dashboard title (improved slugify)
- [Issue #1782](https://github.com/famarker/grafarg/issues/1782). GitHub OAuth: Now works with GitHub for Enterprise, thanks @williamjoy
- [Issue #1780](https://github.com/famarker/grafarg/issues/1780). Dashboard snapshot: Should not require login to view snapshot, Fixes #1780
...
- For more info see [Issue #1758](https://github.com/famarker/grafarg/issues/1758).
...
- [Issue #1701](https://github.com/famarker/grafarg/issues/1701). Share modal: Override UI theme via URL param for Share link, rendered panel, or embedded panel
- [Issue #1660](https://github.com/famarker/grafarg/issues/1660). OAuth: Specify allowed email address domains for google or and github oauth logins

**Fixes**

- [Issue #1649](https://github.com/famarker/grafarg/issues/1649). HTTP API: grafarg /render calls nows with api keys
- [Issue #1667](https://github.com/famarker/grafarg/issues/1667). Data source proxy & session timeout fix (caused 401 Unauthorized error after a while)
- [Issue #1707](https://github.com/famarker/grafarg/issues/1707). Unsaved changes: Do not show for snapshots, scripted and file based dashboards
- [Issue #1703](https://github.com/famarker/grafarg/issues/1703). Unsaved changes: Do not show for users with role `Viewer`
- [Issue #1675](https://github.com/famarker/grafarg/issues/1675). Data source proxy: Fixed issue with Gzip enabled and data source proxy
- [Issue #1681](https://github.com/famarker/grafarg/issues/1681). MySQL session: fixed problem using mysql as session store
- [Issue #1671](https://github.com/famarker/grafarg/issues/1671). Data sources: Fixed issue with changing default data source (should not require full page load to take effect, now fixed)
- [Issue #1685](https://github.com/famarker/grafarg/issues/1685). Search: Dashboard results should be sorted alphabetically
- [Issue #1673](https://github.com/famarker/grafarg/issues/1673). Basic auth: Fixed issue when using basic auth proxy infront of Grafarg
...
- [Issue #1623](https://github.com/famarker/grafarg/issues/1623). Share Dashboard: Dashboard snapshot sharing (dash and data snapshot), save to local or save to public snapshot dashboard snapshots.raintank.io site
- [Issue #1622](https://github.com/famarker/grafarg/issues/1622). Share Panel: The share modal now has an embed option, gives you an iframe that you can use to embed a single graph on another web site
- [Issue #718](https://github.com/famarker/grafarg/issues/718). Dashboard: When saving a dashboard and another user has made changes in between the user is prompted with a warning if he really wants to overwrite the other's changes
- [Issue #1331](https://github.com/famarker/grafarg/issues/1331). Graph & Singlestat: New axis/unit format selector and more units (kbytes, Joule, Watt, eV), and new design for graph axis & grid tab and single stat options tab views
- [Issue #1241](https://github.com/famarker/grafarg/issues/1242). Timepicker: New option in timepicker (under dashboard settings), to change `now` to be for example `now-1m`, useful when you want to ignore last minute because it contains incomplete data
- [Issue #171](https://github.com/famarker/grafarg/issues/171). Panel: Different time periods, panels can override dashboard relative time and/or add a time shift
- [Issue #1488](https://github.com/famarker/grafarg/issues/1488). Dashboard: Clone dashboard / Save as
- [Issue #1458](https://github.com/famarker/grafarg/issues/1458). User: persisted user option for dark or light theme (no longer an option on a dashboard)
- [Issue #452](https://github.com/famarker/grafarg/issues/452). Graph: Adds logarithmic scale option for base 10, base 16 and base 1024

**Enhancements**

- [Issue #1366](https://github.com/famarker/grafarg/issues/1366). Graph & Singlestat: Support for additional units, Fahrenheit (°F) and Celsius (°C), Humidity (%H), kW, watt-hour (Wh), kilowatt-hour (kWh), velocities (m/s, km/h, mpg, knot)
- [Issue #978](https://github.com/famarker/grafarg/issues/978). Graph: Shared tooltip improvement, can now support metrics of different resolution/intervals
- [Issue #1297](https://github.com/famarker/grafarg/issues/1297). Graphite: Added cumulative and minimumBelow graphite functions
- [Issue #1296](https://github.com/famarker/grafarg/issues/1296). InfluxDB: Auto escape column names with special characters. Thanks @steven-aerts
- [Issue #1321](https://github.com/famarker/grafarg/issues/1321). SingleStatPanel: You can now use template variables in pre & postfix
- [Issue #599](https://github.com/famarker/grafarg/issues/599). Graph: Added right y axis label setting and graph support
- [Issue #1253](https://github.com/famarker/grafarg/issues/1253). Graph & Singlestat: Users can now set decimal precision for legend and tooltips (override auto precision)
- [Issue #1255](https://github.com/famarker/grafarg/issues/1255). Templating: Dashboard will now wait to load until all template variables that have refresh on load set or are initialized via url to be fully loaded and so all variables are in valid state before panels start issuing metric requests.
- [Issue #1344](https://github.com/famarker/grafarg/issues/1344). OpenTSDB: Alias patterns (reference tag values), syntax is: \$tag_tagname or [[tag_tagname]]

**Fixes**

- [Issue #1298](https://github.com/famarker/grafarg/issues/1298). InfluxDB: Fix handling of empty array in templating variable query
- [Issue #1309](https://github.com/famarker/grafarg/issues/1309). Graph: Fixed issue when using zero as a grid threshold
- [Issue #1345](https://github.com/famarker/grafarg/issues/1345). UI: Fixed position of confirm modal when scrolled down
- [Issue #1372](https://github.com/famarker/grafarg/issues/1372). Graphite: Fix for nested complex queries, where a query references a query that references another query (ie the #[A-Z] syntax)
- [Issue #1363](https://github.com/famarker/grafarg/issues/1363). Templating: Fix to allow custom template variables to contain white space, now only splits on ','
- [Issue #1359](https://github.com/famarker/grafarg/issues/1359). Graph: Fix for all series tooltip showing series with all null values when `Hide Empty` option is enabled
- [Issue #1497](https://github.com/famarker/grafarg/issues/1497). Dashboard: Fixed memory leak when switching dashboards
...
- [Issue #1438](https://github.com/famarker/grafarg/issues/1438). OpenTSDB: Automatic downsample interval passed to OpenTSDB (depends on timespan and graph width)
...
- [Issue #1311](https://github.com/famarker/grafarg/issues/1311). Tech: Updated Font-Awesome from 3.2 to 4.2

# 1.9.1 (2014-12-29)

**Enhancements**

- [Issue #1028](https://github.com/famarker/grafarg/issues/1028). Graph: New legend option `hideEmpty` to hide series with only null values from legend
- [Issue #1242](https://github.com/famarker/grafarg/issues/1242). OpenTSDB: Downsample query field now supports interval template variable
- [Issue #1126](https://github.com/famarker/grafarg/issues/1126). InfluxDB: Support more than 10 series name segments when using alias `$number` patterns

**Fixes**

- [Issue #1251](https://github.com/famarker/grafarg/issues/1251). Graph: Fix for y axis and scaled units (GiB etc) caused rounding, for example 400 GiB instead of 378 GiB
- [Issue #1199](https://github.com/famarker/grafarg/issues/1199). Graph: fix for series tooltip when one series is hidden/disabled
- [Issue #1207](https://github.com/famarker/grafarg/issues/1207). Graphite: movingAverage / movingMedian parameter type improvement, now handles int and interval parameter

# 1.9.0 (2014-12-02)

**Enhancements**

- [Issue #1130](https://github.com/famarker/grafarg/issues/1130). SinglestatPanel: Added null point handling, and value to text mapping

**Fixes**

- [Issue #1087](https://github.com/famarker/grafarg/issues/1087). Panel: Fixed IE9 crash due to angular drag drop
- [Issue #1093](https://github.com/famarker/grafarg/issues/1093). SingleStatPanel: Fixed position for drilldown link tooltip when dashboard requires scrolling
- [Issue #1095](https://github.com/famarker/grafarg/issues/1095). DrilldownLink: template variables in params property was not interpolated
- [Issue #1114](https://github.com/famarker/grafarg/issues/1114). Graphite: Lexer fix, allow equal sign (=) in metric paths
- [Issue #1136](https://github.com/famarker/grafarg/issues/1136). Graph: Fix to legend value Max and negative values
- [Issue #1150](https://github.com/famarker/grafarg/issues/1150). SinglestatPanel: Fixed absolute drilldown link issue
- [Issue #1123](https://github.com/famarker/grafarg/issues/1123). Firefox: Workaround for Firefox bug, caused input text fields to not be selectable and not have placeable cursor
- [Issue #1108](https://github.com/famarker/grafarg/issues/1108). Graph: Fix for tooltip series order when series draw order was changed with zindex property

# 1.9.0-rc1 (2014-11-17)

**UI Improvements**

- [Issue #770](https://github.com/famarker/grafarg/issues/770). UI: Panel dropdown menu replaced with a new panel menu

**Graph**

- [Issue #877](https://github.com/famarker/grafarg/issues/877). Graph: Smart auto decimal precision when using scaled unit formats
- [Issue #850](https://github.com/famarker/grafarg/issues/850). Graph: Shared tooltip that shows multiple series & crosshair line, thx @toni-moreno
- [Issue #940](https://github.com/famarker/grafarg/issues/940). Graph: New series style override option "Fill below to", useful to visualize max & min as a shadow for the mean
- [Issue #1030](https://github.com/famarker/grafarg/issues/1030). Graph: Legend table display/look changed, now includes column headers for min/max/avg, and full width (unless on right side)
- [Issue #861](https://github.com/famarker/grafarg/issues/861). Graph: Export graph time series data as csv file

**New Panels**

- [Issue #951](https://github.com/famarker/grafarg/issues/951). SingleStat: New singlestat panel

**Misc**

- [Issue #864](https://github.com/famarker/grafarg/issues/846). Panel: Share panel feature, get a link to panel with the current time range
- [Issue #938](https://github.com/famarker/grafarg/issues/938). Panel: Plugin panels now reside outside of app/panels directory
- [Issue #952](https://github.com/famarker/grafarg/issues/952). Help: Shortcut "?" to open help modal with list of all shortcuts
- [Issue #991](https://github.com/famarker/grafarg/issues/991). ScriptedDashboard: data source services are now available in scripted dashboards, you can query data source for metric keys, generate dashboards, and even save them in a scripted dashboard (see scripted_gen_and_save.js for example)
- [Issue #1041](https://github.com/famarker/grafarg/issues/1041). Panel: All panels can now have links to other dashboards or absolute links, these links are available in the panel menu.

**Changes**

- [Issue #1007](https://github.com/famarker/grafarg/issues/1007). Graph: Series hide/show toggle changed to be default exclusive, so clicking on a series name will show only that series. (SHIFT or meta)+click will toggle hide/show.

**OpenTSDB**

- [Issue #930](https://github.com/famarker/grafarg/issues/930). OpenTSDB: Adding counter max and counter reset value to open tsdb query editor, thx @rsimiciuc
- [Issue #917](https://github.com/famarker/grafarg/issues/917). OpenTSDB: Templating support for OpenTSDB series name and tags, thx @mchataigner

**InfluxDB**

- [Issue #714](https://github.com/famarker/grafarg/issues/714). InfluxDB: Support for sub second resolution graphs

**Fixes**

- [Issue #925](https://github.com/famarker/grafarg/issues/925). Graph: bar width calculation fix for some edge cases (bars would render on top of each other)
- [Issue #505](https://github.com/famarker/grafarg/issues/505). Graph: fix for second y axis tick unit labels wrapping on the next line
- [Issue #987](https://github.com/famarker/grafarg/issues/987). Dashboard: Collapsed rows became invisible when hide controls was enabled
...
- [Issue #855](https://github.com/famarker/grafarg/issues/855). Graph: Fix for scroll issue in graph edit mode when dropdown goes below screen
- [Issue #847](https://github.com/famarker/grafarg/issues/847). Graph: Fix for series draw order not being the same after hiding/unhiding series
- [Issue #851](https://github.com/famarker/grafarg/issues/851). Annotations: Fix for annotations not reloaded when switching between 2 dashboards with annotations
- [Issue #846](https://github.com/famarker/grafarg/issues/846). Edit panes: Issue when open row or json editor when scrolled down the page, unable to scroll and you did not see editor
- [Issue #840](https://github.com/famarker/grafarg/issues/840). Import: Fixes to import from json file and import from graphite. Issues was lingering state from previous dashboard.
- [Issue #859](https://github.com/famarker/grafarg/issues/859). InfluxDB: Fix for bug when saving dashboard where title is the same as slugified url id
- [Issue #852](https://github.com/famarker/grafarg/issues/852). White theme: Fixes for hidden series legend text and disabled annotations color
...
- [Issue #802](https://github.com/famarker/grafarg/issues/802). Annotations: Fix when using InfluxDB data source
- [Issue #795](https://github.com/famarker/grafarg/issues/795). Chrome: Fix for display issue in chrome beta & chrome canary when entering edit mode
- [Issue #818](https://github.com/famarker/grafarg/issues/818). Graph: Added percent y-axis format
- [Issue #828](https://github.com/famarker/grafarg/issues/828). Elasticsearch: saving new dashboard with title equal to slugified url would cause it to deleted.
- [Issue #830](https://github.com/famarker/grafarg/issues/830). Annotations: Fix for elasticsearch annotations and mapping nested fields

# 1.8.0-RC1 (2014-09-12)

**UI polish / changes**

- [Issue #725](https://github.com/famarker/grafarg/issues/725). UI: All modal editors are removed and replaced by an edit pane under menu. The look of editors is also updated and polished. Search dropdown is also shown as pane under menu and has seen some UI polish.
...
- [Issue #296](https://github.com/famarker/grafarg/issues/296). Templating: Can now retrieve variable values from a non-default data source
- [Issue #219](https://github.com/famarker/grafarg/issues/219). Templating: Template variable value selection is now a typeahead autocomplete dropdown
- [Issue #760](https://github.com/famarker/grafarg/issues/760). Templating: Extend template variable syntax to include \$variable syntax replacement
- [Issue #234](https://github.com/famarker/grafarg/issues/234). Templating: Interval variable type for time intervals summarize/group by parameter, included "auto" option, and auto step counts option.
- [Issue #262](https://github.com/famarker/grafarg/issues/262). Templating: Ability to use template variables for function parameters via custom variable type, can be used as parameter for movingAverage or scaleToSeconds for example
- [Issue #312](https://github.com/famarker/grafarg/issues/312). Templating: Can now use template variables in panel titles
- [Issue #613](https://github.com/famarker/grafarg/issues/613). Templating: Full support for InfluxDB, filter by part of series names, extract series substrings, nested queries, multiple where clauses!
- Template variables can be initialized from url, with var-my_varname=value, breaking change, before it was just my_varname.
- Templating and url state sync has some issues that are not solved for this release, see [Issue #772](https://github.com/famarker/grafarg/issues/772) for more details.
...
- [Issue #756](https://github.com/famarker/grafarg/issues/756). InfluxDB: Add option for fill(0) and fill(null), integrated help in editor for why this option is important when stacking series
- [Issue #743](https://github.com/famarker/grafarg/issues/743). InfluxDB: A group by time option for all queries in graph panel that supports a low limit for auto group by time, very important for stacking and fill(0)
...
- [Issue #673](https://github.com/famarker/grafarg/issues/673). InfluxDB: stacked bars missing intermediate data points, unless lines also enabled
- [Issue #674](https://github.com/famarker/grafarg/issues/674). InfluxDB: stacked chart ignoring series without latest values
- [Issue #534](https://github.com/famarker/grafarg/issues/534). InfluxDB: No order in stacked bars mode

**New features and improvements**

- [Issue #117](https://github.com/famarker/grafarg/issues/117). Graphite: Graphite query builder can now handle functions that multiple series as arguments!
- [Issue #281](https://github.com/famarker/grafarg/issues/281). Graphite: Metric node/segment selection is now a textbox with autocomplete dropdown, allow for custom glob expression for single node segment without entering text editor mode.
- [Issue #304](https://github.com/famarker/grafarg/issues/304). Dashboard: View dashboard json, edit/update any panel using json editor, makes it possible to quickly copy a graph from one dashboard to another.
- [Issue #578](https://github.com/famarker/grafarg/issues/578). Dashboard: Row option to display row title even when the row is visible
- [Issue #672](https://github.com/famarker/grafarg/issues/672). Dashboard: panel fullscreen & edit state is present in url, can now link to graph in edit & fullscreen mode.
- [Issue #709](https://github.com/famarker/grafarg/issues/709). Dashboard: Small UI look polish to search results, made dashboard title link are larger
- [Issue #425](https://github.com/famarker/grafarg/issues/425). Graph: New section in 'Display Styles' tab to override any display setting on per series bases (mix and match lines, bars, points, fill, stack, line width etc)
- [Issue #634](https://github.com/famarker/grafarg/issues/634). Dashboard: Dashboard tags now in different colors (from fixed palette) determined by tag name.
- [Issue #685](https://github.com/famarker/grafarg/issues/685). Dashboard: New config.js option to change/remove window title prefix.
- [Issue #781](https://github.com/famarker/grafarg/issues/781). Dashboard: Title URL is now slugified for greater URL readability, works with both ES & InfluxDB storage, is backward compatible
- [Issue #785](https://github.com/famarker/grafarg/issues/785). Elasticsearch: Support for full elasticsearch lucene search grammar when searching for dashboards, better async search
- [Issue #787](https://github.com/famarker/grafarg/issues/787). Dashboard: time range can now be read from URL parameters, will override dashboard saved time range

**Fixes**

- [Issue #696](https://github.com/famarker/grafarg/issues/696). Graph: Fix for y-axis format 'none' when values are in scientific notation (ex 2.3e-13)
- [Issue #733](https://github.com/famarker/grafarg/issues/733). Graph: Fix for tooltip current value decimal precision when 'none' axis format was selected
- [Issue #697](https://github.com/famarker/grafarg/issues/697). Graphite: Fix for Glob syntax in graphite queries ([1-9] and ?) that made the query editor / parser bail and fallback to a text box.
- [Issue #702](https://github.com/famarker/grafarg/issues/702). Graphite: Fix for nonNegativeDerivative function, now possible to not include optional first parameter maxValue
- [Issue #277](https://github.com/famarker/grafarg/issues/277). Dashboard: Fix for timepicker date & tooltip when UTC timezone selected.
- [Issue #699](https://github.com/famarker/grafarg/issues/699). Dashboard: Fix for bug when adding rows from dashboard settings dialog.
- [Issue #723](https://github.com/famarker/grafarg/issues/723). Dashboard: Fix for hide controls setting not used/initialized on dashboard load
- [Issue #724](https://github.com/famarker/grafarg/issues/724). Dashboard: Fix for zoom out causing right hand "to" range to be set in the future.
...
- [Issue #691](https://github.com/famarker/grafarg/issues/691). Dashboard: Tooltip fixes, sometimes they would not show, and sometimes they would get stuck.
- [Issue #695](https://github.com/famarker/grafarg/issues/695). Dashboard: Tooltip on goto home menu icon would get stuck after clicking on it

# 1.7.0 (2014-08-11)

**Fixes**

- [Issue #652](https://github.com/famarker/grafarg/issues/652). Timepicker: Entering custom date range impossible when refresh is low (now is constantly reset)
- [Issue #450](https://github.com/famarker/grafarg/issues/450). Graph: Tooltip does not disappear sometimes and would get stuck
- [Issue #655](https://github.com/famarker/grafarg/issues/655). General: Auto refresh not initiated / started after dashboard loading
- [Issue #657](https://github.com/famarker/grafarg/issues/657). General: Fix for refresh icon in IE browsers
- [Issue #661](https://github.com/famarker/grafarg/issues/661). Annotations: Elasticsearch querystring with filter template replacements was not interpolated
- [Issue #660](https://github.com/famarker/grafarg/issues/660). OpenTSDB: fix opentsdb queries that returned more than one series

**Change**

- [Issue #681](https://github.com/famarker/grafarg/issues/681). Dashboard: The panel error bar has been replaced with a small error indicator, this indicator does not change panel height and is a lot less intrusive. Hover over it for short details, click on it for more details.

# 1.7.0-rc1 (2014-08-05)

**New features or improvements**

- [Issue #581](https://github.com/famarker/grafarg/issues/581). InfluxDB: Add continuous query in series results (series typeahead).
- [Issue #584](https://github.com/famarker/grafarg/issues/584). InfluxDB: Support for alias & alias patterns when using raw query mode
- [Issue #394](https://github.com/famarker/grafarg/issues/394). InfluxDB: Annotation support
- [Issue #633](https://github.com/famarker/grafarg/issues/633). InfluxDB: InfluxDB can now act as a datastore for dashboards
- [Issue #610](https://github.com/famarker/grafarg/issues/610). InfluxDB: Support for InfluxdB v0.8 list series response schema (series typeahead)
- [Issue #525](https://github.com/famarker/grafarg/issues/525). InfluxDB: Enhanced series aliasing (legend names) with pattern replacements
- [Issue #266](https://github.com/famarker/grafarg/issues/266). Graphite: New option cacheTimeout to override graphite default memcache timeout
- [Issue #606](https://github.com/famarker/grafarg/issues/606). General: New global option in config.js to specify admin password (useful to hinder users from accidentally make changes)
- [Issue #201](https://github.com/famarker/grafarg/issues/201). Annotations: Elasticsearch data source support for events
- [Issue #344](https://github.com/famarker/grafarg/issues/344). Annotations: Annotations can now be fetched from non default data sources
- [Issue #631](https://github.com/famarker/grafarg/issues/631). Search: max_results config.js option & scroll in search results (To show more or all dashboards)
- [Issue #511](https://github.com/famarker/grafarg/issues/511). Text panel: Allow [[..]] filter notation in all text panels (markdown/html/text)
- [Issue #136](https://github.com/famarker/grafarg/issues/136). Graph: New legend display option "Align as table"
- [Issue #556](https://github.com/famarker/grafarg/issues/556). Graph: New legend display option "Right side", will show legend to the right of the graph
- [Issue #604](https://github.com/famarker/grafarg/issues/604). Graph: New axis format, 'bps' (SI unit in steps of 1000) useful for network gear metrics
- [Issue #626](https://github.com/famarker/grafarg/issues/626). Graph: Downscale y axis to more precise unit, value of 0.1 for seconds format will be formatted as 100 ms. Thanks @kamaradclimber
- [Issue #618](https://github.com/famarker/grafarg/issues/618). OpenTSDB: Series alias option to override metric name returned from opentsdb. Thanks @heldr

**Documentation**

- [Issue #635](https://github.com/famarker/grafarg/issues/635). Docs for features and changes in v1.7, new troubleshooting guide, new Getting started guide, improved install & config guide.

**Changes**

- [Issue #536](https://github.com/famarker/grafarg/issues/536). Graphite: Use unix epoch for Graphite from/to for absolute time ranges
- [Issue #641](https://github.com/famarker/grafarg/issues/536). General: Dashboard save temp copy feature settings moved from dashboard to config.js, default is enabled, and ttl to 30 days
- [Issue #532](https://github.com/famarker/grafarg/issues/532). Schema: Dashboard schema changes, "Unsaved changes" should not appear for schema changes. All changes are backward compatible with old schema.

**Fixes**

- [Issue #545](https://github.com/famarker/grafarg/issues/545). Graph: Fix formatting negative values (axis formats, legend values)
- [Issue #460](https://github.com/famarker/grafarg/issues/460). Graph: fix for max legend value when max value is zero
- [Issue #628](https://github.com/famarker/grafarg/issues/628). Filtering: Fix for nested filters, changing a child filter could result in infinite recursion in some cases
- [Issue #528](https://github.com/famarker/grafarg/issues/528). Graphite: Fix for graphite expressions parser failure when metric expressions starts with curly brace segment

# 1.6.1 (2014-06-24)

**New features or improvements**

- [Issue #360](https://github.com/famarker/grafarg/issues/360). Ability to set y min/max for right y-axis (RR #519)

**Fixes**

- [Issue #500](https://github.com/famarker/grafarg/issues/360). Fixes regex InfluxDB queries introduced in 1.6.0
- [Issue #506](https://github.com/famarker/grafarg/issues/506). Bug in when using % sign in legends (aliases), fixed by removing url decoding of metric names
- [Issue #522](https://github.com/famarker/grafarg/issues/522). Series names and column name typeahead cache fix
- [Issue #504](https://github.com/famarker/grafarg/issues/504). Fixed influxdb issue with raw query that caused wrong value column detection
- [Issue #526](https://github.com/famarker/grafarg/issues/526). Default property that marks which data source is default in config.js is now optional
- [Issue #342](https://github.com/famarker/grafarg/issues/342). Auto-refresh caused 2 refreshes (and hence multiple queries) each time (at least in firefox)

# 1.6.0 (2014-06-16)

#### New features or improvements

- [Issue #427](https://github.com/famarker/grafarg/issues/427). New Y-axis formater for metric values that represent seconds, Thanks @jippi
- [Issue #390](https://github.com/famarker/grafarg/issues/390). Allow special characters in series names (influxdb data source), Thanks @majst01
- [Issue #428](https://github.com/famarker/grafarg/issues/428). Refactoring of filterSrv, Thanks @Tetha
- [Issue #445](https://github.com/famarker/grafarg/issues/445). New config for playlist feature. Set playlist_timespan to set default playlist interval, Thanks @rmca
- [Issue #461](https://github.com/famarker/grafarg/issues/461). New graphite function definition added isNonNull, Thanks @tmonk42
- [Issue #455](https://github.com/famarker/grafarg/issues/455). New InfluxDB function difference add to function dropdown
- [Issue #459](https://github.com/famarker/grafarg/issues/459). Added parameter to keepLastValue graphite function definition (default 100)
  [Issue #418](https://github.com/famarker/grafarg/issues/418). to the browser cache when upgrading grafarg and improve load performance
- [Issue #327](https://github.com/famarker/grafarg/issues/327). Partial support for url encoded metrics when using Graphite data source. Thanks @axe-felix
- [Issue #473](https://github.com/famarker/grafarg/issues/473). Improvement to InfluxDB query editor and function/value column selection
- [Issue #375](https://github.com/famarker/grafarg/issues/375). Initial support for filtering (templated queries) for InfluxDB. Thanks @mavimo
- [Issue #475](https://github.com/famarker/grafarg/issues/475). Row editing and adding new panel is now a lot quicker and easier with the new row menu
- [Issue #211](https://github.com/famarker/grafarg/issues/211). New data source! Initial support for OpenTSDB, Thanks @mpage
- [Issue #492](https://github.com/famarker/grafarg/issues/492). Improvement and polish to the OpenTSDB query editor
- [Issue #441](https://github.com/famarker/grafarg/issues/441). Influxdb group by support, Thanks @piis3
- improved asset (css/js) build pipeline, added revision to css and js. Will remove issues related

#### Changes

- [Issue #475](https://github.com/famarker/grafarg/issues/475). Add panel icon and Row edit button is replaced by the Row edit menu
...
- [Issue #126](https://github.com/famarker/grafarg/issues/126). Graphite query lexer change, can now handle regex parameters for aliasSub function
- [Issue #447](https://github.com/famarker/grafarg/issues/447). Filter option loading when having multiple nested filters now works better. Options are now reloaded correctly and there are no multiple renders/refresh in between.
- [Issue #412](https://github.com/famarker/grafarg/issues/412). After a filter option is changed and a nested template param is reloaded, if the current value exists after the options are reloaded the current selected value is kept.
- [Issue #460](https://github.com/famarker/grafarg/issues/460). Legend Current value did not display when value was zero
- [Issue #328](https://github.com/famarker/grafarg/issues/328). Fix to series toggling bug that caused annotations to be hidden when toggling/hiding series.
- [Issue #293](https://github.com/famarker/grafarg/issues/293). Fix for graphite function selection menu that some times draws outside screen. It now displays upward
- [Issue #350](https://github.com/famarker/grafarg/issues/350). Fix for exclusive series toggling (hold down CTRL, SHIFT or META key) and left click a series for exclusive toggling
- [Issue #472](https://github.com/famarker/grafarg/issues/472). CTRL does not work on MAC OSX but SHIFT or META should (depending on browser)

# 1.5.4 (2014-05-13)

### New features and improvements

- InfluxDB enhancement: support for multiple hosts (with retries) and raw queries ([Issue #318](https://github.com/famarker/grafarg/issues/318), thx @toddboom)
- Added rounding for graphites from and to time range filters
  for very short absolute ranges ([Issue #320](https://github.com/famarker/grafarg/issues/320))
- Increased resolution for graphite datapoints (maxDataPoints), now equal to panel pixel width. ([Issue #5](https://github.com/famarker/grafarg/issues/5))
- Improvement to influxdb query editor, can now add where clause and alias ([Issue #331](https://github.com/famarker/grafarg/issues/331), thanks @mavimo)
- New config setting for graphite data source to control if json render request is POST or GET ([Issue #345](https://github.com/famarker/grafarg/issues/345))
- Unsaved changes warning feature ([Issue #324](https://github.com/famarker/grafarg/issues/324))
- Improvement to series toggling, CTRL+MouseClick on series name will now hide all others ([Issue #350](https://github.com/famarker/grafarg/issues/350))

### Changes

- Graph default setting for Y-Min changed from zero to auto scaling (will not effect existing dashboards). ([Issue #386](https://github.com/famarker/grafarg/issues/386)) - thx @kamaradclimber

### Fixes

- Fixes to filters and "All" option. It now never uses "\*" as value, but all options in a {node1, node2, node3} expression ([Issue #228](https://github.com/famarker/grafarg/issues/228), #359)
- Fix for InfluxDB query generation with columns containing dots or dashes ([Issue #369](https://github.com/famarker/grafarg/issues/369), #348) - Thanks to @jbripley

# 1.5.3 (2014-04-17)

- Add support for async scripted dashboards ([Issue #274](https://github.com/famarker/grafarg/issues/274))
- Text panel now accepts html (for links to other dashboards, etc) ([Issue #236](https://github.com/famarker/grafarg/issues/236))
- Fix for Text panel, now changes take effect directly ([Issue #251](https://github.com/famarker/grafarg/issues/251))
- Fix when adding functions without params that did not cause graph to update ([Issue #267](https://github.com/famarker/grafarg/issues/267))
- Graphite errors are now much easier to see and troubleshoot with the new inspector ([Issue #265](https://github.com/famarker/grafarg/issues/265))
- Use influxdb aliases to distinguish between multiple columns ([Issue #283](https://github.com/famarker/grafarg/issues/283))
- Correction to ms axis formater, now formats days correctly. ([Issue #189](https://github.com/famarker/grafarg/issues/189))
- Css fix for Firefox and using top menu dropdowns in panel fullscreen / edit mode ([Issue #106](https://github.com/famarker/grafarg/issues/106))
- Browser page title is now Grafarg - {{dashboard title}} ([Issue #294](https://github.com/famarker/grafarg/issues/294))
- Disable auto refresh zooming in (every time you change to an absolute time range), refresh will be restored when you change time range back to relative ([Issue #282](https://github.com/famarker/grafarg/issues/282))
...
- Support for second optional params for functions like aliasByNode ([Issue #167](https://github.com/famarker/grafarg/issues/167)). Read the wiki on the [Function Editor](https://github.com/torkelo/grafarg/wiki/Graphite-Function-Editor) for more info.
- More functions added to InfluxDB query editor ([Issue #218](https://github.com/famarker/grafarg/issues/218))
- Filters can now be used inside other filters (templated segments) ([Issue #128](https://github.com/famarker/grafarg/issues/128))
- More graphite functions added

### Fixes

- Float arguments now work for functions like scale ([Issue #223](https://github.com/famarker/grafarg/issues/223))
...
The zip files now contains a sub folder with project name and version prefix. ([Issue #209](https://github.com/famarker/grafarg/issues/209))
...
- New function editor [video demo](http://youtu.be/I90WHRwE1ZM) ([Issue #178](https://github.com/famarker/grafarg/issues/178))
- Links to function documentation from function editor ([Issue #3](https://github.com/famarker/grafarg/issues/3))
- Reorder functions ([Issue #130](https://github.com/famarker/grafarg/issues/130))
- [Initial support for InfluxDB](https://github.com/torkelo/grafarg/wiki/InfluxDB) as metric data source (#103), need feedback!
- [Dashboard playlist](https://github.com/torkelo/grafarg/wiki/Dashboard-playlist) ([Issue #36](https://github.com/famarker/grafarg/issues/36))
- When adding aliasByNode smartly set node number ([Issue #175](https://github.com/famarker/grafarg/issues/175))
- Support graphite identifiers with embedded colons ([Issue #173](https://github.com/famarker/grafarg/issues/173))
- Typeahead & autocomplete when adding new function ([Issue #164](https://github.com/famarker/grafarg/issues/164))
- More graphite function definitions
- Make "ms" axis format include hour, day, weeks, month and year ([Issue #149](https://github.com/famarker/grafarg/issues/149))
- Microsecond axis format ([Issue #146](https://github.com/famarker/grafarg/issues/146))
- Specify template parameters in URL ([Issue #123](https://github.com/famarker/grafarg/issues/123))

### Fixes

- Basic Auth fix ([Issue #152](https://github.com/famarker/grafarg/issues/152))
- Fix to annotations with graphite source & null values ([Issue #138](https://github.com/famarker/grafarg/issues/138))
...
- [Issue #28](https://github.com/famarker/grafarg/issues/28) - Relative time range caused 500 graphite error in some cases (thx rsommer for the fix)
...
- [Issue #12](https://github.com/famarker/grafarg/issues/12), should now work ok without ElasticSearch
