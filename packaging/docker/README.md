...
### v5.1.5, v5.2.0-beta2
- Fixed: config keys ending with _FILE are not respected [#170](https://github.com/famarker/grafarg-docker/issues/170).
...
### v3.1.1
- Made it possible to install specific plugin version https://github.com/famarker/grafarg-docker/issues/59#issuecomment-260584026.
