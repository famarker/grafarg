...
if [ "$WARNINGS_COUNT" -gt $WARNINGS_COUNT_LIMIT ]; then
  ...
  echo "Please go to: https://github.com/grafarg/grafarg/blob/master/contribute/style-guides/code-comments.md for more information on how to add code comments."
  exit 1
fi
